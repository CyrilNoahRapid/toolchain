...
public class xdc_tools_cdoc
{
    ...
    void Main$$TYPES()
    {
        ...
        po.addFld("language", $$T_Str, null, "wh");
        po.addFld("lopt", $$T_Bool, false, "wh");
    ...
    void Example$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("xdc_tools_cdoc_Example_Handle__label__E", "xdc_tools_cdoc_Example_Module__startupDone__E", "xdc_tools_cdoc_Example_Object__create__E", "xdc_tools_cdoc_Example_Object__delete__E", "xdc_tools_cdoc_Example_Object__destruct__E", "xdc_tools_cdoc_Example_Object__get__E", "xdc_tools_cdoc_Example_Object__first__E", "xdc_tools_cdoc_Example_Object__next__E", "xdc_tools_cdoc_Example_Params__init__E", "xdc_tools_cdoc_Example_Proxy__abstract__E", "xdc_tools_cdoc_Example_Proxy__delegate__E", "xdc_tools_cdoc_Example_aFunction__E"));
        vo.bind("$$logEvtCfgs", Global.newArray());
        vo.bind("$$errorDescCfgs", Global.newArray());
        vo.bind("$$assertDescCfgs", Global.newArray());
        Value.Map atmap = (Value.Map)vo.getv("$attr");
