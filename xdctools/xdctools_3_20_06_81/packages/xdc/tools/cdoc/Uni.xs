...
{
    PL(Gbl.sprintf("<td colspan='2'><div class='xdocSynTblHdr'>$1</div></td>\n", title));
}
...
/*
 *  @(#) xdc.tools.cdoc; 1, 0, 0, 0,196; 11-16-2010 11:20:54; /db/ztree/library/trees/xdc/xdc-v53x/src/packages/
 */
