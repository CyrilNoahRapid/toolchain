...
metaonly module Main inherits ICmd {
     ...
     *  can create a single file, or a directory tree. In particular it
     *  can create a RTSC package.
     *
     ...
     *      the command line, excluding the template and output
     *
     *    - `this.inputPath`
     ...
     *
     *    - `this.arguments`
     *      an array containing the arguments passed in the varargs
     *      parameter of mkpkg().
     *  @p
     */
...
/*
 *  @(#) xdc.tools.mkpkg; 1, 0, 1, 0,190; 10-15-2010 11:40:53; /db/ztree/library/trees/xdctools/xdctools-d45x/src/
 */
