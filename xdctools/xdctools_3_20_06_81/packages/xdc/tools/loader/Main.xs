...
function run(cmdr, args)
{
    ...
    if (!m) {
        inst.cmd.error("program file contains no assembly information");
    }
    ...
    if (!m) {
        inst.cmd.error("program file contains no platform information");
    }
...
/*
 *  @(#) xdc.tools.loader; 1, 0, 0, 0,112; 10-15-2010 11:40:47; /db/ztree/library/trees/xdctools/xdctools-d45x/src/
 */
