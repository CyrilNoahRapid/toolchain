...
/*
 *  @(#) xdc.tools.path; 1, 0, 0,160; 2-25-2010 10:20:26; /db/ztree/jgc/xdctools-d18x/src/
 */

/*
 *  @(#) xdc.tools.path; 1, 0, 0,189; 10-15-2010 11:41:10; /db/ztree/library/trees/xdctools/xdctools-d45x/src/
 */
