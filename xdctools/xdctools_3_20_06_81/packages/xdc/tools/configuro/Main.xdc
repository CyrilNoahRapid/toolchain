...
instance:
     ...
     *  the `compiler.opt` and `linker.cmd` files. By default, the output
     *  directory has the same name as the configuration script, minus the
     *  `.cfg` extension, within the same parent directory as this script.
     */
    @CommandOption("o")
     ...
     *
     *  Lets the user pass values into the configuration script from the
     *  command line. The argument is an expression in JavaScript syntax.
     *  Its value is available in the configuration script under the name
     *  `Program.build.cfgArgs`.
     *
...
/*
 *  @(#) xdc.tools.configuro; 1, 0, 0, 0,192; 10-15-2010 11:40:11; /db/ztree/library/trees/xdctools/xdctools-d45x/src/
 */
