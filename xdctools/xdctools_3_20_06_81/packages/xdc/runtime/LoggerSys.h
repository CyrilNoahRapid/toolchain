...
/* Proxy__abstract__S */
xdc__CODESECT(xdc_runtime_LoggerSys_Proxy__abstract__S, "xdc_runtime_LoggerSys_Proxy__abstract")
__extern xdc_Bool xdc_runtime_LoggerSys_Proxy__abstract__S( void );

/* Proxy__delegate__S */
xdc__CODESECT(xdc_runtime_LoggerSys_Proxy__delegate__S, "xdc_runtime_LoggerSys_Proxy__delegate")
__extern xdc_Ptr xdc_runtime_LoggerSys_Proxy__delegate__S( void );
