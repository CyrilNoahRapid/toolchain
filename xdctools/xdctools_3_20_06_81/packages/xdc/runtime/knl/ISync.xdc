 ...
 *  {@link #wait}. These two functions are always used in pairs in modules that
 ...
 *  implementations. For non-blocking ISync the wait() will return 
 *  WaitStatus_TIMEOUT to denote timeout.
 */
