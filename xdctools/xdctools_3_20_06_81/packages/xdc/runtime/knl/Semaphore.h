...
/* Handle__label__S */
xdc__CODESECT(xdc_runtime_knl_Semaphore_Handle__label__S, "xdc_runtime_knl_Semaphore_Handle__label")
__extern xdc_runtime_Types_Label* xdc_runtime_knl_Semaphore_Handle__label__S( xdc_Ptr obj, xdc_runtime_Types_Label* lab );
...
/* Object__create__S */
xdc__CODESECT(xdc_runtime_knl_Semaphore_Object__create__S, "xdc_runtime_knl_Semaphore_Object__create")
__extern xdc_Ptr xdc_runtime_knl_Semaphore_Object__create__S( xdc_Ptr __oa, xdc_SizeT __osz, xdc_Ptr __aa, const xdc_UChar* __pa, xdc_SizeT __psz, xdc_runtime_Error_Block* __eb );

/* Object__delete__S */
xdc__CODESECT(xdc_runtime_knl_Semaphore_Object__delete__S, "xdc_runtime_knl_Semaphore_Object__delete")
__extern xdc_Void xdc_runtime_knl_Semaphore_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(xdc_runtime_knl_Semaphore_Object__destruct__S, "xdc_runtime_knl_Semaphore_Object__destruct")
__extern xdc_Void xdc_runtime_knl_Semaphore_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(xdc_runtime_knl_Semaphore_Object__get__S, "xdc_runtime_knl_Semaphore_Object__get")
__extern xdc_Ptr xdc_runtime_knl_Semaphore_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(xdc_runtime_knl_Semaphore_Object__first__S, "xdc_runtime_knl_Semaphore_Object__first")
__extern xdc_Ptr xdc_runtime_knl_Semaphore_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(xdc_runtime_knl_Semaphore_Object__next__S, "xdc_runtime_knl_Semaphore_Object__next")
__extern xdc_Ptr xdc_runtime_knl_Semaphore_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(xdc_runtime_knl_Semaphore_Params__init__S, "xdc_runtime_knl_Semaphore_Params__init")
__extern xdc_Void xdc_runtime_knl_Semaphore_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );

/* Proxy__abstract__S */
xdc__CODESECT(xdc_runtime_knl_Semaphore_Proxy__abstract__S, "xdc_runtime_knl_Semaphore_Proxy__abstract")
__extern xdc_Bool xdc_runtime_knl_Semaphore_Proxy__abstract__S( void );

/* Proxy__delegate__S */
xdc__CODESECT(xdc_runtime_knl_Semaphore_Proxy__delegate__S, "xdc_runtime_knl_Semaphore_Proxy__delegate")
__extern xdc_Ptr xdc_runtime_knl_Semaphore_Proxy__delegate__S( void );
