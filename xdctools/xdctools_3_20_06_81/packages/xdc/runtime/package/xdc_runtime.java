...
public class xdc_runtime
{
    ...
    void Log$$SINGLETONS()
    {
        ...
        vo.bind("$$logEvtCfgs", Global.newArray("L_construct", "L_create", "L_destruct", "L_delete", "L_error", "L_warning", "L_info"));
        vo.bind("$$errorDescCfgs", Global.newArray());
        vo.bind("$$assertDescCfgs", Global.newArray());
        Value.Map atmap = (Value.Map)vo.getv("$attr");
        atmap.setElem("", true);
    ...
    void Registry$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("xdc_runtime_Registry_Handle__label__E", "xdc_runtime_Registry_Module__startupDone__E", "xdc_runtime_Registry_Object__create__E", "xdc_runtime_Registry_Object__delete__E", "xdc_runtime_Registry_Object__destruct__E", "xdc_runtime_Registry_Object__get__E", "xdc_runtime_Registry_Object__first__E", "xdc_runtime_Registry_Object__next__E", "xdc_runtime_Registry_Params__init__E", "xdc_runtime_Registry_Proxy__abstract__E", "xdc_runtime_Registry_Proxy__delegate__E", "xdc_runtime_Registry_addModule__E", "xdc_runtime_Registry_findByName__E", "xdc_runtime_Registry_findByNamePattern__E", "xdc_runtime_Registry_findById__E", "xdc_runtime_Registry_getMask__E", "xdc_runtime_Registry_isMember__E", "xdc_runtime_Registry_getNextModule__E", "xdc_runtime_Registry_getModuleName__E", "xdc_runtime_Registry_getModuleId__E"));
        vo.bind("$$logEvtCfgs", Global.newArray());
        vo.bind("$$errorDescCfgs", Global.newArray());
        vo.bind("$$assertDescCfgs", Global.newArray());
        Value.Map atmap = (Value.Map)vo.getv("$attr");
