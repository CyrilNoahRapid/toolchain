...
public class xdc_rov_support
{
    ...
    void ScalarStructs$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("xdc_rov_support_ScalarStructs_Handle__label__E", "xdc_rov_support_ScalarStructs_Module__startupDone__E", "xdc_rov_support_ScalarStructs_Object__create__E", "xdc_rov_support_ScalarStructs_Object__delete__E", "xdc_rov_support_ScalarStructs_Object__destruct__E", "xdc_rov_support_ScalarStructs_Object__get__E", "xdc_rov_support_ScalarStructs_Object__first__E", "xdc_rov_support_ScalarStructs_Object__next__E", "xdc_rov_support_ScalarStructs_Params__init__E", "xdc_rov_support_ScalarStructs_Proxy__abstract__E", "xdc_rov_support_ScalarStructs_Proxy__delegate__E"));
