...
public class xdc_rov_dss
{
    ...
    void Main$$OBJECTS()
    {
        ...
        po = (Proto.Obj)om.bind("xdc.rov.dss.Main.Module", new Proto.Obj());
        vo = (Value.Obj)om.bind("xdc.rov.dss.Main", new Value.Obj("xdc.rov.dss.Main", po));
        pkgV.bind("Main", vo);
        // decls 
        // insts 
        Object insP = om.bind("xdc.rov.dss.Main.Instance", new Proto.Obj());
        po = (Proto.Obj)om.bind("xdc.rov.dss.Main$$Object", new Proto.Obj());
        Object objP = om.bind("xdc.rov.dss.Main.Object", new Proto.Str(po, true));
        po = (Proto.Obj)om.bind("xdc.rov.dss.Main$$Params", new Proto.Obj());
        om.bind("xdc.rov.dss.Main.Params", new Proto.Str(po, true));
    }
    ...
    void Main$$CREATES()
    {
        ...
        fxn = (Proto.Fxn)om.bind("xdc.rov.dss.Main$$create", new Proto.Fxn(om.findStrict("xdc.rov.dss.Main.Module", "xdc.rov.dss"), om.findStrict("xdc.rov.dss.Main.Instance", "xdc.rov.dss"), 1, 0, false));
                fxn.addArg(0, "__params", (Proto)om.findStrict("xdc.rov.dss.Main.Params", "xdc.rov.dss"), Global.newObject());
        sb = new StringBuilder();
        sb.append("xdc$rov$dss$Main$$create = function( __params ) {\n");
            sb.append("var __mod = xdc.om['xdc.rov.dss.Main'];\n");
            sb.append("var __inst = xdc.om['xdc.rov.dss.Main.Instance'].$$make();\n");
        ...
        fxn = (Proto.Fxn)om.bind("xdc.rov.dss.Main$$construct", new Proto.Fxn(om.findStrict("xdc.rov.dss.Main.Module", "xdc.rov.dss"), null, 2, 0, false));
                fxn.addArg(0, "__obj", (Proto)om.findStrict("xdc.rov.dss.Main$$Object", "xdc.rov.dss"), null);
                fxn.addArg(1, "__params", (Proto)om.findStrict("xdc.rov.dss.Main.Params", "xdc.rov.dss"), Global.newObject());
        sb = new StringBuilder();
        sb.append("xdc$rov$dss$Main$$construct = function( __obj, __params ) {\n");
            sb.append("var __mod = xdc.om['xdc.rov.dss.Main'];\n");
    ...
    void Main$$TYPES()
    {
        ...
        cap = (Scriptable)Global.callFxn("loadCapsule", xdcO, "xdc/rov/dss/Main.xs");
        om.bind("xdc.rov.dss.Main$$capsule", cap);
        po = (Proto.Obj)om.findStrict("xdc.rov.dss.Main.Module", "xdc.rov.dss");
        po.init("xdc.rov.dss.Main.Module", om.findStrict("xdc.tools.ICmd.Module", "xdc.rov.dss"));
                po.addFld("$hostonly", $$T_Num, 1, "r");
                po.addFld("usage", new Proto.Arr($$T_Str, false), Global.newArray(new Object[]{" ", "Usage", "[-v] [-m module] [-o out file] [-d dump file] executable", "[--help]", " "}), "wh");
                po.addFxn("create", (Proto.Fxn)om.findStrict("xdc.rov.dss.Main$$create", "xdc.rov.dss"), Global.get("xdc$rov$dss$Main$$create"));
                po.addFxn("construct", (Proto.Fxn)om.findStrict("xdc.rov.dss.Main$$construct", "xdc.rov.dss"), Global.get("xdc$rov$dss$Main$$construct"));
                fxn = Global.get(cap, "module$use");
                if (fxn != null) om.bind("xdc.rov.dss.Main$$module$use", true);
                if (fxn != null) po.addFxn("module$use", $$T_Met, fxn);
                fxn = Global.get(cap, "module$meta$init");
                if (fxn != null) om.bind("xdc.rov.dss.Main$$module$meta$init", true);
                if (fxn != null) po.addFxn("module$meta$init", $$T_Met, fxn);
                fxn = Global.get(cap, "instance$meta$init");
                if (fxn != null) om.bind("xdc.rov.dss.Main$$instance$meta$init", true);
                if (fxn != null) po.addFxn("instance$meta$init", $$T_Met, fxn);
                fxn = Global.get(cap, "module$validate");
                if (fxn != null) om.bind("xdc.rov.dss.Main$$module$validate", true);
                if (fxn != null) po.addFxn("module$validate", $$T_Met, fxn);
                fxn = Global.get(cap, "main");
                if (fxn != null) po.addFxn("main", (Proto.Fxn)om.findStrict("xdc.tools.ICmd$$main", "xdc.rov.dss"), fxn);
                fxn = Global.get(cap, "exec");
                if (fxn != null) po.addFxn("exec", (Proto.Fxn)om.findStrict("xdc.tools.ICmd$$exec", "xdc.rov.dss"), fxn);
        po = (Proto.Obj)om.findStrict("xdc.rov.dss.Main.Instance", "xdc.rov.dss");
        po.init("xdc.rov.dss.Main.Instance", om.findStrict("xdc.tools.ICmd.Instance", "xdc.rov.dss"));
                po.addFld("$hostonly", $$T_Num, 1, "r");
                po.addFld("verboseFlag", $$T_Bool, false, "wh");
                po.addFld("mods", $$T_Str, null, "wh");
                po.addFld("output", $$T_Str, "", "wh");
                po.addFld("dumpFile", $$T_Str, "", "wh");
                fxn = Global.get(cap, "run");
                if (fxn != null) po.addFxn("run", (Proto.Fxn)om.findStrict("xdc.tools.ICmd$$run", "xdc.rov.dss"), fxn);
        po = (Proto.Obj)om.findStrict("xdc.rov.dss.Main$$Params", "xdc.rov.dss");
        po.init("xdc.rov.dss.Main.Params", om.findStrict("xdc.tools.ICmd$$Params", "xdc.rov.dss"));
                po.addFld("$hostonly", $$T_Num, 1, "r");
                po.addFld("verboseFlag", $$T_Bool, false, "wh");
                po.addFld("mods", $$T_Str, null, "wh");
                po.addFld("output", $$T_Str, "", "wh");
                po.addFld("dumpFile", $$T_Str, "", "wh");
        po = (Proto.Obj)om.findStrict("xdc.rov.dss.Main$$Object", "xdc.rov.dss");
        po.init("xdc.rov.dss.Main.Object", om.findStrict("xdc.rov.dss.Main.Instance", "xdc.rov.dss"));
                fxn = Global.get(cap, "run");
                if (fxn != null) po.addFxn("run", (Proto.Fxn)om.findStrict("xdc.tools.ICmd$$run", "xdc.rov.dss"), fxn);
    }
    ...
    void Main$$SINGLETONS()
    {
        ...
        vo = (Value.Obj)om.findStrict("xdc.rov.dss.Main", "xdc.rov.dss");
        po = (Proto.Obj)om.findStrict("xdc.rov.dss.Main.Module", "xdc.rov.dss");
        vo.init2(po, "xdc.rov.dss.Main", $$DEFAULT, false);
        vo.bind("Module", po);
        vo.bind("$category", "Module");
        vo.bind("$capsule", om.findStrict("xdc.rov.dss.Main$$capsule", "xdc.rov.dss"));
        vo.bind("Instance", om.findStrict("xdc.rov.dss.Main.Instance", "xdc.rov.dss"));
        vo.bind("Params", om.findStrict("xdc.rov.dss.Main.Params", "xdc.rov.dss"));
        vo.bind("PARAMS", ((Proto.Str)om.findStrict("xdc.rov.dss.Main.Params", "xdc.rov.dss")).newInstance());
        ...
        vo.bind("$$meta_iobj", om.has("xdc.rov.dss.Main$$instance$static$init", null) ? 1 : 0);
        ...
        atmap.seal("length");
        vo.bind("Object", om.findStrict("xdc.rov.dss.Main.Object", "xdc.rov.dss"));
        pkgV.bind("Main", vo);
    ...
    void $$INITIALIZATION()
    {
        ...
        Global.callFxn("module$meta$init", (Scriptable)om.findStrict("xdc.rov.dss.Main", "xdc.rov.dss"));
        ...
        ((Value.Obj)om.getv("xdc.rov.dss.Main")).bless();
