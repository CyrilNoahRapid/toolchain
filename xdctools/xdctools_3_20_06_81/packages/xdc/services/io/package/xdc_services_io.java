...
public class xdc_services_io
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['release/Doss.lib', {target: 'microsoft.targets.VC98'}],\n");
            sb.append("['debug/Doss.lib', {target: 'microsoft.targets.VC98'}],\n");
        sb.append("];\n");
        sb.append("if('suffix' in xdc.om['xdc.IPackage$$LibDesc']) {\n");
            sb.append("pkg.build.libDesc['release/Doss.lib'].suffix = '86';\n");
            sb.append("pkg.build.libDesc['debug/Doss.lib'].suffix = '86';\n");
        sb.append("}\n");
        Global.eval(sb.toString());
    }
