...
{
    xdc.jre.xdc.services.intern.xsr.Template.apply(this.fxn, outStream, thisObj, args == undefined ? [] : args);
};
...
//    print("compiling template " + path + " ...");
    ...
    return xdc.jre.org.mozilla.javascript.Context.getCurrentContext().evaluateString(xdc.global, fs, path, 1, null);
};
/*
 *  @(#) xdc; 1, 1, 1,298; 11-16-2010 11:19:56; /db/ztree/library/trees/xdc/xdc-v53x/src/packages/
 */
