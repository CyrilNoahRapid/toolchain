...
metaonly module Executable {
     ...
     *
     *  @field(rtsName)  This string names a RunTime Support (RTS) package that
     *          will be implicitly loaded prior to running the executable's
     *          configuration script.  If this field is set to `null`, then
     *          no RTS package will be loaded.  If this field is not set (or
     *          set to `undefined`), the RTS package specified by this
    ...
    struct Attrs {
        ...
        Bool    isRom;          /*! if true, exe is a ROMable sub-assembly */
    };
