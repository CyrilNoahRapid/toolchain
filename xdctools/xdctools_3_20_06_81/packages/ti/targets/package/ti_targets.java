...
public class ti_targets
{
    ...
    void C66$$TYPES()
    {
        ...
        po.addFld("model", (Proto)om.findStrict("xdc.bld.ITarget.Model", "ti.targets"), Global.newObject("endian", "little", "shortEnums", true), "rh");
        po.addFld("base", (Proto)om.findStrict("xdc.bld.ITarget.Module", "ti.targets"), om.find("ti.targets.C62"), "rh");
        po.addFld("rts", $$T_Str, "ti.targets.rts6000", "rh");
    ...
    void C66_big_endian$$TYPES()
    {
        ...
        po.addFld("isa", $$T_Str, "66", "rh");
        po.addFld("model", (Proto)om.findStrict("xdc.bld.ITarget.Model", "ti.targets"), Global.newObject("endian", "big", "shortEnums", true), "rh");
        po.addFld("base", (Proto)om.findStrict("xdc.bld.ITarget.Module", "ti.targets"), om.find("ti.targets.C62"), "rh");
        po.addFld("rts", $$T_Str, "ti.targets.rts6000", "rh");
        po.addFld("platform", $$T_Str, "ti.platforms.simTCI6616", "wh");
        po.addFld("ar", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets"), Global.newObject("cmd", "ar6x", "opts", "rq"), "rh");
    ...
    void C55$$TYPES()
    {
        ...
        po.addFld("vers", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets"), Global.newObject("cmd", "cl55", "opts", ""), "rh");
