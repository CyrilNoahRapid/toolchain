...
public class ti_targets_elf
{
    ...
    void T16$$OBJECTS()
    {
        ...
        po = (Proto.Obj)om.bind("ti.targets.elf.T16.Module", new Proto.Obj());
        vo = (Value.Obj)om.bind("ti.targets.elf.T16", new Value.Obj("ti.targets.elf.T16", po));
        pkgV.bind("T16", vo);
        // decls 
        om.bind("ti.targets.elf.T16.Model", om.findStrict("xdc.bld.ITarget.Model", "ti.targets.elf"));
        om.bind("ti.targets.elf.T16.DebugGen", om.findStrict("xdc.bld.ITarget.DebugGen", "ti.targets.elf"));
        om.bind("ti.targets.elf.T16.Extension", om.findStrict("xdc.bld.ITarget.Extension", "ti.targets.elf"));
        om.bind("ti.targets.elf.T16.CompileOptions", om.findStrict("xdc.bld.ITarget.CompileOptions", "ti.targets.elf"));
        om.bind("ti.targets.elf.T16.OptionSet", om.findStrict("xdc.bld.ITarget.OptionSet", "ti.targets.elf"));
        om.bind("ti.targets.elf.T16.CompileGoal", om.findStrict("xdc.bld.ITarget.CompileGoal", "ti.targets.elf"));
        om.bind("ti.targets.elf.T16.LinkGoal", om.findStrict("xdc.bld.ITarget.LinkGoal", "ti.targets.elf"));
        om.bind("ti.targets.elf.T16.ArchiveGoal", om.findStrict("xdc.bld.ITarget.ArchiveGoal", "ti.targets.elf"));
        om.bind("ti.targets.elf.T16.CommandSet", om.findStrict("xdc.bld.ITarget.CommandSet", "ti.targets.elf"));
        om.bind("ti.targets.elf.T16.TypeInfo", om.findStrict("xdc.bld.ITarget.TypeInfo", "ti.targets.elf"));
        om.bind("ti.targets.elf.T16.StdTypes", om.findStrict("xdc.bld.ITarget.StdTypes", "ti.targets.elf"));
        om.bind("ti.targets.elf.T16.Command", om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"));
        om.bind("ti.targets.elf.T16.Options", om.findStrict("xdc.bld.ITarget2.Options", "ti.targets.elf"));
    }
    ...
    void ITarget$$TYPES()
    {
        ...
        po.addFld("sectMap", new Proto.Map($$T_Str), Global.newArray(new Object[]{Global.newArray(new Object[]{".text", "code"}), Global.newArray(new Object[]{".ti.decompress", "code"}), Global.newArray(new Object[]{".stack", "stack"}), Global.newArray(new Object[]{".bss", "data"}), Global.newArray(new Object[]{".cinit", "data"}), Global.newArray(new Object[]{".init_array", "data"}), Global.newArray(new Object[]{".const", "data"}), Global.newArray(new Object[]{".data", "data"}), Global.newArray(new Object[]{".rodata", "data"}), Global.newArray(new Object[]{".neardata", "data"}), Global.newArray(new Object[]{".fardata", "data"}), Global.newArray(new Object[]{".switch", "data"}), Global.newArray(new Object[]{".sysmem", "data"}), Global.newArray(new Object[]{".far", "data"}), Global.newArray(new Object[]{".args", "data"}), Global.newArray(new Object[]{".cio", "data"}), Global.newArray(new Object[]{".ti.handler_table", "data"})}), "rh");
    ...
    void C64P$$TYPES()
    {
        ...
        po.addFld("cc", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "cl6x -c", "opts", "-mv64p --abi=elfabi"), "rh");
        ...
        po.addFld("asm", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "cl6x -c", "opts", "-mv64P --abi=elfabi"), "rh");
        po.addFld("lnk", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "lnk6x", "opts", "--abi=elfabi"), "rh");
    ...
    void C674$$TYPES()
    {
        ...
        po.addFld("ar", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "ar6x", "opts", "rq"), "rh");
        po.addFld("cc", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "cl6x -c", "opts", "-mv6740 --abi=elfabi"), "rh");
        po.addFld("vers", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "cl6x", "opts", "--compiler_revision"), "rh");
        po.addFld("asm", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "cl6x -c", "opts", "-mv6740 --abi=elfabi"), "rh");
        po.addFld("lnk", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "lnk6x", "opts", "--abi=elfabi"), "rh");
        po.addFld("asmOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "ti.targets.elf"), Global.newObject("prefix", "-qq", "suffix", ""), "wh");
        po.addFld("ccOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "ti.targets.elf"), Global.newObject("prefix", "-qq -pdsw225", "suffix", ""), "wh");
        po.addFld("ccConfigOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "ti.targets.elf"), Global.newObject("prefix", "$(ccOpts.prefix) -mo --no_compress", "suffix", "$(ccOpts.suffix)"), "wh");
    ...
    void C64T$$TYPES()
    {
        ...
        po.addFld("ar", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "ar6x", "opts", "rq"), "rh");
        po.addFld("cc", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "cl6x -c", "opts", "-mv=tesla --abi=elfabi"), "rh");
        po.addFld("vers", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "cl6x", "opts", "--compiler_revision"), "rh");
        po.addFld("asm", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "cl6x -c", "opts", "-mv=tesla --abi=elfabi"), "rh");
        po.addFld("lnk", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "lnk6x", "opts", "--abi=elfabi"), "rh");
        po.addFld("asmOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "ti.targets.elf"), Global.newObject("prefix", "-qq", "suffix", ""), "wh");
        po.addFld("ccOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "ti.targets.elf"), Global.newObject("prefix", "-qq -pdsw225", "suffix", ""), "wh");
        po.addFld("ccConfigOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "ti.targets.elf"), Global.newObject("prefix", "$(ccOpts.prefix) -mo --no_compress", "suffix", "$(ccOpts.suffix)"), "wh");
    ...
    void C67P$$TYPES()
    {
        ...
        po.addFld("ar", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "ar6x", "opts", "rq"), "rh");
        po.addFld("cc", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "cl6x -c", "opts", "-mv67p --abi=elfabi"), "rh");
        po.addFld("vers", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "cl6x", "opts", "--compiler_revision"), "rh");
        po.addFld("asm", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "cl6x -c", "opts", "-mv67p --abi=elfabi"), "rh");
        po.addFld("lnk", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "lnk6x", "opts", "--abi=elfabi"), "rh");
        po.addFld("asmOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "ti.targets.elf"), Global.newObject("prefix", "-qq", "suffix", ""), "wh");
        po.addFld("ccOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "ti.targets.elf"), Global.newObject("prefix", "-qq -pdsw225", "suffix", ""), "wh");
    ...
    void C64P_big_endian$$TYPES()
    {
        ...
        po.addFld("platform", $$T_Str, "ti.platforms.sim6xxx:TMS320CDM420", "wh");
        po.addFld("ar", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "ar6x", "opts", "rq"), "rh");
        po.addFld("cc", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "cl6x -c", "opts", "-me -mv64p --abi=elfabi"), "rh");
        po.addFld("vers", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "cl6x", "opts", "--compiler_revision"), "rh");
        po.addFld("asm", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "cl6x -c", "opts", "-me -mv64p --abi=elfabi"), "rh");
        po.addFld("lnk", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "lnk6x", "opts", "--abi=elfabi"), "rh");
        po.addFld("asmOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "ti.targets.elf"), Global.newObject("prefix", "-qq", "suffix", ""), "wh");
        po.addFld("ccOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "ti.targets.elf"), Global.newObject("prefix", "-qq -pdsw225", "suffix", ""), "wh");
        po.addFld("ccConfigOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "ti.targets.elf"), Global.newObject("prefix", "$(ccOpts.prefix) -mo --no_compress", "suffix", "$(ccOpts.suffix)"), "wh");
    ...
    void C674_big_endian$$TYPES()
    {
        ...
        po.addFld("platform", $$T_Str, "ti.platforms.evmDA830", "wh");
        po.addFld("ar", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "ar6x", "opts", "rq"), "rh");
        po.addFld("cc", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "cl6x -c", "opts", "-me -mv6740 --abi=elfabi"), "rh");
        po.addFld("vers", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "cl6x", "opts", "--compiler_revision"), "rh");
        po.addFld("asm", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "cl6x -c", "opts", "-me -mv6740 --abi=elfabi"), "rh");
        po.addFld("lnk", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "lnk6x", "opts", " --abi=elfabi"), "rh");
        po.addFld("asmOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "ti.targets.elf"), Global.newObject("prefix", "-qq", "suffix", ""), "wh");
        po.addFld("ccOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "ti.targets.elf"), Global.newObject("prefix", "-qq -pdsw225", "suffix", ""), "wh");
        po.addFld("ccConfigOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "ti.targets.elf"), Global.newObject("prefix", "$(ccOpts.prefix) -mo --no_compress", "suffix", "$(ccOpts.suffix)"), "wh");
    ...
    void C64T_big_endian$$TYPES()
    {
        ...
        po.addFld("platform", $$T_Str, "ti.platforms.sdp4430", "wh");
        po.addFld("ar", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "ar6x", "opts", "rq"), "rh");
        po.addFld("cc", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "cl6x -c", "opts", "-me -mv=tesla --abi=elfabi"), "rh");
        po.addFld("vers", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "cl6x", "opts", "--compiler_revision"), "rh");
        po.addFld("asm", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "cl6x -c", "opts", "-me -mv=tesla --abi=elfabi"), "rh");
        po.addFld("lnk", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "lnk6x", "opts", "--abi=elfabi"), "rh");
        po.addFld("asmOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "ti.targets.elf"), Global.newObject("prefix", "-qq", "suffix", ""), "wh");
        po.addFld("ccOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "ti.targets.elf"), Global.newObject("prefix", "-qq -pdsw225", "suffix", ""), "wh");
        po.addFld("ccConfigOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "ti.targets.elf"), Global.newObject("prefix", "$(ccOpts.prefix) -mo --no_compress", "suffix", "$(ccOpts.suffix)"), "wh");
    ...
    void C66$$TYPES()
    {
        ...
        po.addFld("ar", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "ar6x", "opts", "rq"), "rh");
        po.addFld("cc", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "cl6x -c", "opts", "-mv6600 --abi=elfabi"), "rh");
        po.addFld("vers", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "cl6x", "opts", "--compiler_revision"), "rh");
        po.addFld("asm", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "cl6x -c", "opts", "-mv6600 --abi=elfabi"), "rh");
        po.addFld("lnk", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "lnk6x", "opts", "--abi=elfabi"), "rh");
        po.addFld("asmOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "ti.targets.elf"), Global.newObject("prefix", "-qq", "suffix", ""), "wh");
        po.addFld("ccOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "ti.targets.elf"), Global.newObject("prefix", "-qq -pdsw225", "suffix", ""), "wh");
        po.addFld("ccConfigOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "ti.targets.elf"), Global.newObject("prefix", "$(ccOpts.prefix) -mo", "suffix", "$(ccOpts.suffix)"), "wh");
    ...
    void C66_big_endian$$TYPES()
    {
        ...
        po.addFld("platform", $$T_Str, "ti.platforms.simTCI6616", "wh");
        po.addFld("ar", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "ar6x", "opts", "rq"), "rh");
        po.addFld("cc", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "cl6x -c", "opts", "-me -mv6600 --abi=elfabi"), "rh");
        po.addFld("vers", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "cl6x", "opts", "--compiler_revision"), "rh");
        po.addFld("asm", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "cl6x -c", "opts", "-me -mv6600 --abi=elfabi"), "rh");
        po.addFld("lnk", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "lnk6x", "opts", "--abi=elfabi"), "rh");
        po.addFld("asmOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "ti.targets.elf"), Global.newObject("prefix", "-qq", "suffix", ""), "wh");
        po.addFld("ccOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "ti.targets.elf"), Global.newObject("prefix", "-qq -pdsw225", "suffix", ""), "wh");
        po.addFld("ccConfigOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "ti.targets.elf"), Global.newObject("prefix", "$(ccOpts.prefix) -mo", "suffix", "$(ccOpts.suffix)"), "wh");
    ...
    void TMS470$$TYPES()
    {
        ...
        po.addFld("profiles", new Proto.Map((Proto)om.findStrict("xdc.bld.ITarget.OptionSet", "ti.targets.elf")), Global.newArray(new Object[]{Global.newArray(new Object[]{"debug", Global.newObject("compileOpts", Global.newObject("copts", "-g", "defs", "-D_DEBUG_=1"))}), Global.newArray(new Object[]{"release", Global.newObject("compileOpts", Global.newObject("copts", "-O2"))}), Global.newArray(new Object[]{"profile", Global.newObject("compileOpts", Global.newObject("copts", "--symdebug:dwarf"))}), Global.newArray(new Object[]{"coverage", Global.newObject("compileOpts", Global.newObject("copts", "--symdebug:dwarf"))}), Global.newArray(new Object[]{"whole_program", Global.newObject("compileOpts", Global.newObject("copts", "-oe -O2 -ms"))}), Global.newArray(new Object[]{"whole_program_debug", Global.newObject("compileOpts", Global.newObject("copts", "-oe --symdebug:dwarf -ms"))})}), "wh");
    ...
    void T16$$TYPES()
    {
        ...
        po = (Proto.Obj)om.findStrict("ti.targets.elf.T16.Module", "ti.targets.elf");
        po.init("ti.targets.elf.T16.Module", om.findStrict("ti.targets.elf.ITarget.Module", "ti.targets.elf"));
                po.addFld("$hostonly", $$T_Num, 1, "r");
        po.addFld("name", $$T_Str, "T16", "rh");
        po.addFld("suffix", $$T_Str, "et16", "rh");
        po.addFld("isa", $$T_Str, "t16", "rh");
        po.addFld("model", (Proto)om.findStrict("xdc.bld.ITarget.Model", "ti.targets.elf"), Global.newObject("endian", "little"), "rh");
        po.addFld("rts", $$T_Str, "ti.targets.elf.rtst16", "rh");
        po.addFld("platform", $$T_Str, "ti.platforms.simT16", "wh");
        po.addFld("ar", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "art16", "opts", "rq"), "rh");
        po.addFld("cc", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "clt16 -c", "opts", "--silicon_version=v210"), "rh");
        po.addFld("asm", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "clt16 -c", "opts", "--silicon_version=v210"), "rh");
        po.addFld("lnk", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "lnkt16", "opts", ""), "rh");
        po.addFld("vers", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.elf"), Global.newObject("cmd", "clt16", "opts", "--compiler_revision"), "rh");
        po.addFld("asmOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "ti.targets.elf"), Global.newObject("prefix", "-qq", "suffix", ""), "wh");
        po.addFld("ccOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "ti.targets.elf"), Global.newObject("prefix", "-qq -pdsw225", "suffix", ""), "wh");
        po.addFld("ccConfigOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "ti.targets.elf"), Global.newObject("prefix", "$(ccOpts.prefix)", "suffix", "$(ccOpts.suffix)"), "wh");
        po.addFld("lnkOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "ti.targets.elf"), Global.newObject("prefix", "-w -q -u _c_int00", "suffix", "-c -m $(XDCCFGDIR)/$@.map -l $(rootDir)/lib/rtst16_v200.lib"), "wh");
        po.addFld("includeOpts", $$T_Str, "-I$(rootDir)/include", "wh");
        po.addFld("stdTypes", (Proto)om.findStrict("xdc.bld.ITarget.StdTypes", "ti.targets.elf"), Global.newObject("t_IArg", Global.newObject("size", 4L, "align", 4L), "t_Char", Global.newObject("size", 1L, "align", 1L), "t_Double", Global.newObject("size", 8L, "align", 8L), "t_Float", Global.newObject("size", 4L, "align", 4L), "t_Fxn", Global.newObject("size", 4L, "align", 4L), "t_Int", Global.newObject("size", 4L, "align", 4L), "t_Int8", Global.newObject("size", 1L, "align", 1L), "t_Int16", Global.newObject("size", 2L, "align", 2L), "t_Int32", Global.newObject("size", 4L, "align", 4L), "t_Int40", Global.newObject("size", 8L, "align", 8L), "t_Int64", Global.newObject("size", 8L, "align", 8L), "t_Long", Global.newObject("size", 8L, "align", 8L), "t_LDouble", Global.newObject("size", 8L, "align", 8L), "t_LLong", Global.newObject("size", 8L, "align", 8L), "t_Ptr", Global.newObject("size", 4L, "align", 4L), "t_Short", Global.newObject("size", 2L, "align", 2L), "t_Size", Global.newObject("size", 4L, "align", 4L)), "rh");
        po.addFld("bitsPerChar", Proto.Elm.newCNum("(xdc_Int)"), 8L, "rh");
        po.addFld("profiles", new Proto.Map((Proto)om.findStrict("xdc.bld.ITarget.OptionSet", "ti.targets.elf")), Global.newArray(new Object[]{Global.newArray(new Object[]{"debug", Global.newObject("compileOpts", Global.newObject("copts", "-g", "defs", "-D_DEBUG_=1"))}), Global.newArray(new Object[]{"release", Global.newObject("compileOpts", Global.newObject("copts", "-O2"))}), Global.newArray(new Object[]{"profile", Global.newObject("compileOpts", Global.newObject("copts", "--symdebug:dwarf"))}), Global.newArray(new Object[]{"coverage", Global.newObject("compileOpts", Global.newObject("copts", "--symdebug:dwarf"))}), Global.newArray(new Object[]{"whole_program", Global.newObject("compileOpts", Global.newObject("copts", "-oe -O2 --gen_func_subsections"))}), Global.newArray(new Object[]{"whole_program_debug", Global.newObject("compileOpts", Global.newObject("copts", "-oe --symdebug:dwarf --gen_func_subsections"))})}), "wh");
                po.addFxn("archive", (Proto.Fxn)om.findStrict("xdc.bld.ITarget$$archive", "ti.targets.elf"), $$UNDEF);
                po.addFxn("compile", (Proto.Fxn)om.findStrict("xdc.bld.ITarget$$compile", "ti.targets.elf"), $$UNDEF);
                po.addFxn("scompile", (Proto.Fxn)om.findStrict("xdc.bld.ITarget$$scompile", "ti.targets.elf"), $$UNDEF);
                po.addFxn("link", (Proto.Fxn)om.findStrict("xdc.bld.ITarget$$link", "ti.targets.elf"), $$UNDEF);
    ...
    void T16$$SINGLETONS()
    {
        ...
        vo = (Value.Obj)om.findStrict("ti.targets.elf.T16", "ti.targets.elf");
        po = (Proto.Obj)om.findStrict("ti.targets.elf.T16.Module", "ti.targets.elf");
        vo.init2(po, "ti.targets.elf.T16", $$DEFAULT, false);
        vo.bind("Module", po);
        vo.bind("$category", "Module");
        vo.bind("$capsule", $$UNDEF);
        vo.bind("$package", om.findStrict("ti.targets.elf", "ti.targets.elf"));
        ...
        Proto.Str ps = (Proto.Str)vo.find("Module_State");
        if (ps != null) vo.bind("$object", ps.newInstance());
        vo.bind("$$meta_iobj", om.has("ti.targets.elf.T16$$instance$static$init", null) ? 1 : 0);
        vo.bind("$$fxntab", Global.newArray());
        vo.bind("$$logEvtCfgs", Global.newArray());
        vo.bind("$$errorDescCfgs", Global.newArray());
        vo.bind("$$assertDescCfgs", Global.newArray());
        ...
        atmap.seal("length");
        pkgV.bind("T16", vo);
        ((Value.Arr)pkgV.getv("$unitNames")).add("T16");
    }
    ...
    void $$INITIALIZATION()
    {
        ...
        Global.callFxn("module$meta$init", (Scriptable)om.findStrict("ti.targets.elf.T16", "ti.targets.elf"));
        ...
        ((Value.Obj)om.getv("ti.targets.elf.T16")).bless();
