 ...
 *  ======== genElfSymbols ========
 *
 *  This function generates some additional symbols for t16 ELF builds, which
...
{
    var res = "/* T16 Elf symbols */\n";
    if (prog.build.target.isa == "t16") {
        res += "--symbol_map __TI_STACK_BASE=_stack\n";
    }
