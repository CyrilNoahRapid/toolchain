...
public class ti_targets_omf_elf
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libDesc = [\n");
            ...
            sb.append("['lib/elf.aea8f', {target: 'ti.targets.arm.elf.A8F'}],\n");
            sb.append("['lib/elf.a66', {target: 'ti.targets.C66'}],\n");
            ...
            sb.append("['lib/elf.a66e', {target: 'ti.targets.C66_big_endian'}],\n");
            ...
            sb.append("['lib/elf.aet16', {target: 'ti.targets.elf.T16'}],\n");
            ...
            sb.append("['lib/elf.ae66', {target: 'ti.targets.elf.C66'}],\n");
            sb.append("['lib/elf.am3e', {target: 'ti.targets.arm.M3_big_endian'}],\n");
            sb.append("['lib/elf.aea8ft', {target: 'ti.targets.arm.elf.A8Ft'}],\n");
            sb.append("['lib/elf.ae64Te', {target: 'ti.targets.elf.C64T_big_endian'}],\n");
            sb.append("['lib/elf.ae66e', {target: 'ti.targets.elf.C66_big_endian'}],\n");
            ...
            sb.append("['lib/elf.av4TCE', {target: 'microsoft.targets.arm.WinCE'}],\n");
        ...
        sb.append("if('suffix' in xdc.om['xdc.IPackage$$LibDesc']) {\n");
            ...
            sb.append("pkg.build.libDesc['lib/elf.aea8f'].suffix = 'ea8f';\n");
            sb.append("pkg.build.libDesc['lib/elf.a66'].suffix = '66';\n");
            ...
            sb.append("pkg.build.libDesc['lib/elf.a66e'].suffix = '66e';\n");
            ...
            sb.append("pkg.build.libDesc['lib/elf.aet16'].suffix = 'et16';\n");
            ...
            sb.append("pkg.build.libDesc['lib/elf.ae66'].suffix = 'e66';\n");
            sb.append("pkg.build.libDesc['lib/elf.am3e'].suffix = 'm3e';\n");
            sb.append("pkg.build.libDesc['lib/elf.aea8ft'].suffix = 'ea8ft';\n");
            sb.append("pkg.build.libDesc['lib/elf.ae64Te'].suffix = 'e64Te';\n");
            sb.append("pkg.build.libDesc['lib/elf.ae66e'].suffix = 'e66e';\n");
            ...
            sb.append("pkg.build.libDesc['lib/elf.av4TCE'].suffix = 'v4TCE';\n");
