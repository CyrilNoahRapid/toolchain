...
public class ti_targets_rts6000
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libDesc = [\n");
            ...
            sb.append("['lib/boot.ae66', {target: 'ti.targets.elf.C66'}],\n");
            sb.append("['lib/ti.targets.rts6000.a64', {target: 'ti.targets.C64'}],\n");
            sb.append("['lib/ti.targets.rts6000.a66', {target: 'ti.targets.C66'}],\n");
            sb.append("['lib/ti.targets.rts6000.a67', {target: 'ti.targets.C67'}],\n");
            sb.append("['lib/boot.a66e', {target: 'ti.targets.C66_big_endian'}],\n");
            ...
            sb.append("['lib/boot.a66', {target: 'ti.targets.C66'}],\n");
            ...
            sb.append("['lib/ti.targets.rts6000.ae66', {target: 'ti.targets.elf.C66'}],\n");
            ...
            sb.append("['lib/ti.targets.rts6000.a66e', {target: 'ti.targets.C66_big_endian'}],\n");
            ...
            sb.append("['lib/ti.targets.rts6000.ae66e', {target: 'ti.targets.elf.C66_big_endian'}],\n");
            ...
            sb.append("['lib/boot.ae66e', {target: 'ti.targets.elf.C66_big_endian'}],\n");
        ...
        sb.append("if('suffix' in xdc.om['xdc.IPackage$$LibDesc']) {\n");
            ...
            sb.append("pkg.build.libDesc['lib/boot.ae66'].suffix = 'e66';\n");
            sb.append("pkg.build.libDesc['lib/ti.targets.rts6000.a64'].suffix = '64';\n");
            sb.append("pkg.build.libDesc['lib/ti.targets.rts6000.a66'].suffix = '66';\n");
            sb.append("pkg.build.libDesc['lib/ti.targets.rts6000.a67'].suffix = '67';\n");
            sb.append("pkg.build.libDesc['lib/boot.a66e'].suffix = '66e';\n");
            ...
            sb.append("pkg.build.libDesc['lib/boot.a66'].suffix = '66';\n");
            ...
            sb.append("pkg.build.libDesc['lib/ti.targets.rts6000.ae66'].suffix = 'e66';\n");
            ...
            sb.append("pkg.build.libDesc['lib/ti.targets.rts6000.a66e'].suffix = '66e';\n");
            ...
            sb.append("pkg.build.libDesc['lib/ti.targets.rts6000.ae66e'].suffix = 'e66e';\n");
            ...
            sb.append("pkg.build.libDesc['lib/boot.ae66e'].suffix = 'e66e';\n");
