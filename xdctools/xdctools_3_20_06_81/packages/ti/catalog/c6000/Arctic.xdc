...
instance:
    ...
    config xdc.platform.IPlatform.Memory memMap[string]  = [
        ...
        /*
         *  This memory needs to be defined here as a workaround because
         *  IPC generates a section that needs to be placed here. Once
         *  we fix the enhancement SDOCM00077090 in IPC, this can be removed.
         */
        ["DMEM", {
            comment:    "T16 Internal data memory",
            name:       "DMEM",
            base:       0x20020000,
            len:        0x8000,
            space:      "data",
...
/*
 *  @(#) ti.catalog.c6000; 1, 0, 0, 0,295; 12-3-2010 11:43:47; /db/ztree/library/trees/platform/platform-l29x/src/
 */
