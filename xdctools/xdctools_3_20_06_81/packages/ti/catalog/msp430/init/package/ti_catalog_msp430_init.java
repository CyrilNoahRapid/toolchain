...
public class ti_catalog_msp430_init
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/ti.catalog.msp430.init.a430XS', {target: 'ti.targets.msp430.MSP430X_small'}],\n");
            sb.append("['lib/ti.catalog.msp430.init.a430', {target: 'ti.targets.msp430.MSP430'}],\n");
            sb.append("['lib/ti.catalog.msp430.init.a430X', {target: 'ti.targets.msp430.MSP430X'}],\n");
        sb.append("];\n");
        sb.append("if('suffix' in xdc.om['xdc.IPackage$$LibDesc']) {\n");
            sb.append("pkg.build.libDesc['lib/ti.catalog.msp430.init.a430XS'].suffix = '430XS';\n");
            sb.append("pkg.build.libDesc['lib/ti.catalog.msp430.init.a430'].suffix = '430';\n");
            sb.append("pkg.build.libDesc['lib/ti.catalog.msp430.init.a430X'].suffix = '430X';\n");
        sb.append("}\n");
