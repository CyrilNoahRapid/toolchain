...
requires ti.catalog;
requires ti.catalog.msp430.peripherals.timer;
requires ti.catalog.msp430.peripherals.adc;
requires ti.catalog.msp430.peripherals.clock;
requires ti.catalog.msp430.peripherals.communication;
requires ti.catalog.msp430.peripherals.gpio;
requires ti.catalog.msp430.peripherals.oa;
requires ti.catalog.msp430.peripherals.special_function;
requires ti.catalog.msp430.peripherals.watchdog;
requires ti.catalog.msp430.peripherals.interrupt;
