...
instance:
    ...
    config ti.catalog.msp430.peripherals.timer.Timer_A5.Instance TA0;
    config ti.catalog.msp430.peripherals.timer.Timer_A3.Instance TA1;
    config ti.catalog.msp430.peripherals.timer.Timer_A3.Instance TA2;
    config ti.catalog.msp430.peripherals.timer.Timer_B7.Instance TB0;
