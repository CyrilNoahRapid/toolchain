...
public class ti_catalog_msp430_peripherals_oa
{
    ...
    void OA_3$$OBJECTS()
    {
        ...
        po = (Proto.Obj)om.bind("ti.catalog.msp430.peripherals.oa.OA_3.Module", new Proto.Obj());
        vo = (Value.Obj)om.bind("ti.catalog.msp430.peripherals.oa.OA_3", new Value.Obj("ti.catalog.msp430.peripherals.oa.OA_3", po));
        pkgV.bind("OA_3", vo);
        // decls 
        om.bind("ti.catalog.msp430.peripherals.oa.OA_3.OAN_t", om.findStrict("ti.catalog.msp430.peripherals.oa.IOA.OAN_t", "ti.catalog.msp430.peripherals.oa"));
        om.bind("ti.catalog.msp430.peripherals.oa.OA_3.OAP_t", om.findStrict("ti.catalog.msp430.peripherals.oa.IOA.OAP_t", "ti.catalog.msp430.peripherals.oa"));
        om.bind("ti.catalog.msp430.peripherals.oa.OA_3.OAPM_t", om.findStrict("ti.catalog.msp430.peripherals.oa.IOA.OAPM_t", "ti.catalog.msp430.peripherals.oa"));
        om.bind("ti.catalog.msp430.peripherals.oa.OA_3.OAADC0_t", om.findStrict("ti.catalog.msp430.peripherals.oa.IOA.OAADC0_t", "ti.catalog.msp430.peripherals.oa"));
        om.bind("ti.catalog.msp430.peripherals.oa.OA_3.OAADC1_t", om.findStrict("ti.catalog.msp430.peripherals.oa.IOA.OAADC1_t", "ti.catalog.msp430.peripherals.oa"));
        om.bind("ti.catalog.msp430.peripherals.oa.OA_3.OAFBR_t", om.findStrict("ti.catalog.msp430.peripherals.oa.IOA.OAFBR_t", "ti.catalog.msp430.peripherals.oa"));
        om.bind("ti.catalog.msp430.peripherals.oa.OA_3.OAFC_t", om.findStrict("ti.catalog.msp430.peripherals.oa.IOA.OAFC_t", "ti.catalog.msp430.peripherals.oa"));
        om.bind("ti.catalog.msp430.peripherals.oa.OA_3.OARRIP_t", om.findStrict("ti.catalog.msp430.peripherals.oa.IOA.OARRIP_t", "ti.catalog.msp430.peripherals.oa"));
        om.bind("ti.catalog.msp430.peripherals.oa.OA_3.OANEXT_t", om.findStrict("ti.catalog.msp430.peripherals.oa.IOA.OANEXT_t", "ti.catalog.msp430.peripherals.oa"));
        om.bind("ti.catalog.msp430.peripherals.oa.OA_3.OAxCTL0_t", om.findStrict("ti.catalog.msp430.peripherals.oa.IOA.OAxCTL0_t", "ti.catalog.msp430.peripherals.oa"));
        om.bind("ti.catalog.msp430.peripherals.oa.OA_3.OAxCTL1_t", om.findStrict("ti.catalog.msp430.peripherals.oa.IOA.OAxCTL1_t", "ti.catalog.msp430.peripherals.oa"));
        om.bind("ti.catalog.msp430.peripherals.oa.OA_3.ForceSetDefaultRegister_t", om.findStrict("ti.catalog.msp430.peripherals.oa.IOA.ForceSetDefaultRegister_t", "ti.catalog.msp430.peripherals.oa"));
        // insts 
        Object insP = om.bind("ti.catalog.msp430.peripherals.oa.OA_3.Instance", new Proto.Obj());
        po = (Proto.Obj)om.bind("ti.catalog.msp430.peripherals.oa.OA_3$$Object", new Proto.Obj());
        Object objP = om.bind("ti.catalog.msp430.peripherals.oa.OA_3.Object", new Proto.Str(po, true));
        po = (Proto.Obj)om.bind("ti.catalog.msp430.peripherals.oa.OA_3$$Params", new Proto.Obj());
        om.bind("ti.catalog.msp430.peripherals.oa.OA_3.Params", new Proto.Str(po, true));
    }
    ...
    void OA_3$$CREATES()
    {
        ...
        fxn = (Proto.Fxn)om.bind("ti.catalog.msp430.peripherals.oa.OA_3$$create", new Proto.Fxn(om.findStrict("ti.catalog.msp430.peripherals.oa.OA_3.Module", "ti.catalog.msp430.peripherals.oa"), om.findStrict("ti.catalog.msp430.peripherals.oa.OA_3.Instance", "ti.catalog.msp430.peripherals.oa"), 1, 0, false));
                fxn.addArg(0, "__params", (Proto)om.findStrict("ti.catalog.msp430.peripherals.oa.OA_3.Params", "ti.catalog.msp430.peripherals.oa"), Global.newObject());
        sb = new StringBuilder();
        sb.append("ti$catalog$msp430$peripherals$oa$OA_3$$create = function( __params ) {\n");
            sb.append("var __mod = xdc.om['ti.catalog.msp430.peripherals.oa.OA_3'];\n");
            sb.append("var __inst = xdc.om['ti.catalog.msp430.peripherals.oa.OA_3.Instance'].$$make();\n");
            sb.append("__inst.$$bind('$package', xdc.om['ti.catalog.msp430.peripherals.oa']);\n");
            sb.append("__inst.$$bind('$index', __mod.$instances.length);\n");
            sb.append("__inst.$$bind('$category', 'Instance');\n");
            sb.append("__inst.$$bind('$args', {});\n");
        ...
        sb.append("}\n");
        Global.eval(sb.toString());
        fxn = (Proto.Fxn)om.bind("ti.catalog.msp430.peripherals.oa.OA_3$$construct", new Proto.Fxn(om.findStrict("ti.catalog.msp430.peripherals.oa.OA_3.Module", "ti.catalog.msp430.peripherals.oa"), null, 2, 0, false));
                fxn.addArg(0, "__obj", (Proto)om.findStrict("ti.catalog.msp430.peripherals.oa.OA_3$$Object", "ti.catalog.msp430.peripherals.oa"), null);
                fxn.addArg(1, "__params", (Proto)om.findStrict("ti.catalog.msp430.peripherals.oa.OA_3.Params", "ti.catalog.msp430.peripherals.oa"), Global.newObject());
        sb = new StringBuilder();
        sb.append("ti$catalog$msp430$peripherals$oa$OA_3$$construct = function( __obj, __params ) {\n");
            sb.append("var __mod = xdc.om['ti.catalog.msp430.peripherals.oa.OA_3'];\n");
            sb.append("var __inst = __obj;\n");
            sb.append("__inst.$$bind('$args', {});\n");
            sb.append("__inst.$$bind('$module', __mod);\n");
    ...
    void OA_3$$TYPES()
    {
        ...
        cap = (Scriptable)Global.callFxn("loadCapsule", xdcO, "ti/catalog/msp430/peripherals/oa/OA_3.xs");
        om.bind("ti.catalog.msp430.peripherals.oa.OA_3$$capsule", cap);
        po = (Proto.Obj)om.findStrict("ti.catalog.msp430.peripherals.oa.OA_3.Module", "ti.catalog.msp430.peripherals.oa");
        po.init("ti.catalog.msp430.peripherals.oa.OA_3.Module", om.findStrict("ti.catalog.msp430.peripherals.oa.IOA.Module", "ti.catalog.msp430.peripherals.oa"));
                po.addFld("$hostonly", $$T_Num, 1, "r");
                po.addFxn("create", (Proto.Fxn)om.findStrict("ti.catalog.msp430.peripherals.oa.OA_3$$create", "ti.catalog.msp430.peripherals.oa"), Global.get("ti$catalog$msp430$peripherals$oa$OA_3$$create"));
                po.addFxn("construct", (Proto.Fxn)om.findStrict("ti.catalog.msp430.peripherals.oa.OA_3$$construct", "ti.catalog.msp430.peripherals.oa"), Global.get("ti$catalog$msp430$peripherals$oa$OA_3$$construct"));
        fxn = Global.get(cap, "module$use");
        if (fxn != null) om.bind("ti.catalog.msp430.peripherals.oa.OA_3$$module$use", true);
        if (fxn != null) po.addFxn("module$use", $$T_Met, fxn);
        fxn = Global.get(cap, "module$meta$init");
        if (fxn != null) om.bind("ti.catalog.msp430.peripherals.oa.OA_3$$module$meta$init", true);
        if (fxn != null) po.addFxn("module$meta$init", $$T_Met, fxn);
        fxn = Global.get(cap, "instance$meta$init");
        if (fxn != null) om.bind("ti.catalog.msp430.peripherals.oa.OA_3$$instance$meta$init", true);
        if (fxn != null) po.addFxn("instance$meta$init", $$T_Met, fxn);
        fxn = Global.get(cap, "module$validate");
        if (fxn != null) om.bind("ti.catalog.msp430.peripherals.oa.OA_3$$module$validate", true);
        if (fxn != null) po.addFxn("module$validate", $$T_Met, fxn);
                fxn = Global.get(cap, "addPeripheralsMap");
                if (fxn != null) po.addFxn("addPeripheralsMap", (Proto.Fxn)om.findStrict("xdc.platform.IPeripheral$$addPeripheralsMap", "ti.catalog.msp430.peripherals.oa"), fxn);
                fxn = Global.get(cap, "getAll");
                ...
                fxn = Global.get(cap, "getRegisters");
                if (fxn != null) po.addFxn("getRegisters", (Proto.Fxn)om.findStrict("xdc.platform.IPeripheral$$getRegisters", "ti.catalog.msp430.peripherals.oa"), fxn);
        po = (Proto.Obj)om.findStrict("ti.catalog.msp430.peripherals.oa.OA_3.Instance", "ti.catalog.msp430.peripherals.oa");
        po.init("ti.catalog.msp430.peripherals.oa.OA_3.Instance", om.findStrict("ti.catalog.msp430.peripherals.oa.IOA.Instance", "ti.catalog.msp430.peripherals.oa"));
                po.addFld("$hostonly", $$T_Num, 1, "r");
        po.addFld("OA0CTL0", (Proto)om.findStrict("ti.catalog.msp430.peripherals.oa.OA_3.OAxCTL0_t", "ti.catalog.msp430.peripherals.oa"), Global.newObject("OAN", om.find("ti.catalog.msp430.peripherals.oa.IOA.OAN_0"), "OAP", om.find("ti.catalog.msp430.peripherals.oa.IOA.OAP_0"), "OAPM", om.find("ti.catalog.msp430.peripherals.oa.IOA.OAPM_0"), "OAADC0", om.find("ti.catalog.msp430.peripherals.oa.IOA.OAADC0_OFF"), "OAADC1", om.find("ti.catalog.msp430.peripherals.oa.IOA.OAADC1_OFF")), "wh");
        po.addFld("OA0CTL1", (Proto)om.findStrict("ti.catalog.msp430.peripherals.oa.OA_3.OAxCTL1_t", "ti.catalog.msp430.peripherals.oa"), Global.newObject("OAFBR", om.find("ti.catalog.msp430.peripherals.oa.IOA.OAFBR_0"), "OAFC", om.find("ti.catalog.msp430.peripherals.oa.IOA.OAFC_0"), "OANEXT", om.find("ti.catalog.msp430.peripherals.oa.IOA.OANEXT_OFF"), "OARRIP", om.find("ti.catalog.msp430.peripherals.oa.IOA.OARRIP_OFF")), "wh");
        po.addFld("OA1CTL0", (Proto)om.findStrict("ti.catalog.msp430.peripherals.oa.OA_3.OAxCTL0_t", "ti.catalog.msp430.peripherals.oa"), Global.newObject("OAN", om.find("ti.catalog.msp430.peripherals.oa.IOA.OAN_0"), "OAP", om.find("ti.catalog.msp430.peripherals.oa.IOA.OAP_0"), "OAPM", om.find("ti.catalog.msp430.peripherals.oa.IOA.OAPM_0"), "OAADC0", om.find("ti.catalog.msp430.peripherals.oa.IOA.OAADC0_OFF"), "OAADC1", om.find("ti.catalog.msp430.peripherals.oa.IOA.OAADC1_OFF")), "wh");
        po.addFld("OA1CTL1", (Proto)om.findStrict("ti.catalog.msp430.peripherals.oa.OA_3.OAxCTL1_t", "ti.catalog.msp430.peripherals.oa"), Global.newObject("OAFBR", om.find("ti.catalog.msp430.peripherals.oa.IOA.OAFBR_0"), "OAFC", om.find("ti.catalog.msp430.peripherals.oa.IOA.OAFC_0"), "OANEXT", om.find("ti.catalog.msp430.peripherals.oa.IOA.OANEXT_OFF"), "OARRIP", om.find("ti.catalog.msp430.peripherals.oa.IOA.OARRIP_OFF")), "wh");
        po.addFld("OA2CTL0", (Proto)om.findStrict("ti.catalog.msp430.peripherals.oa.OA_3.OAxCTL0_t", "ti.catalog.msp430.peripherals.oa"), Global.newObject("OAN", om.find("ti.catalog.msp430.peripherals.oa.IOA.OAN_0"), "OAP", om.find("ti.catalog.msp430.peripherals.oa.IOA.OAP_0"), "OAPM", om.find("ti.catalog.msp430.peripherals.oa.IOA.OAPM_0"), "OAADC0", om.find("ti.catalog.msp430.peripherals.oa.IOA.OAADC0_OFF"), "OAADC1", om.find("ti.catalog.msp430.peripherals.oa.IOA.OAADC1_OFF")), "wh");
        po.addFld("OA2CTL1", (Proto)om.findStrict("ti.catalog.msp430.peripherals.oa.OA_3.OAxCTL1_t", "ti.catalog.msp430.peripherals.oa"), Global.newObject("OAFBR", om.find("ti.catalog.msp430.peripherals.oa.IOA.OAFBR_0"), "OAFC", om.find("ti.catalog.msp430.peripherals.oa.IOA.OAFC_0"), "OANEXT", om.find("ti.catalog.msp430.peripherals.oa.IOA.OANEXT_OFF"), "OARRIP", om.find("ti.catalog.msp430.peripherals.oa.IOA.OARRIP_OFF")), "wh");
        po.addFld("forceSetDefaultRegister", new Proto.Arr((Proto)om.findStrict("ti.catalog.msp430.peripherals.oa.OA_3.ForceSetDefaultRegister_t", "ti.catalog.msp430.peripherals.oa"), false), Global.newArray(new Object[]{Global.newObject("register", "OA0CTL0", "regForceSet", false), Global.newObject("register", "OA0CTL1", "regForceSet", false), Global.newObject("register", "OA1CTL0", "regForceSet", false), Global.newObject("register", "OA1CTL1", "regForceSet", false), Global.newObject("register", "OA2CTL0", "regForceSet", false), Global.newObject("register", "OA2CTL1", "regForceSet", false)}), "rh");
                fxn = Global.get(cap, "getNumberOfOA");
                if (fxn != null) po.addFxn("getNumberOfOA", (Proto.Fxn)om.findStrict("ti.catalog.msp430.peripherals.oa.IOA$$getNumberOfOA", "ti.catalog.msp430.peripherals.oa"), fxn);
        po = (Proto.Obj)om.findStrict("ti.catalog.msp430.peripherals.oa.OA_3$$Params", "ti.catalog.msp430.peripherals.oa");
        po.init("ti.catalog.msp430.peripherals.oa.OA_3.Params", om.findStrict("ti.catalog.msp430.peripherals.oa.IOA$$Params", "ti.catalog.msp430.peripherals.oa"));
                po.addFld("$hostonly", $$T_Num, 1, "r");
        po.addFld("OA0CTL0", (Proto)om.findStrict("ti.catalog.msp430.peripherals.oa.OA_3.OAxCTL0_t", "ti.catalog.msp430.peripherals.oa"), Global.newObject("OAN", om.find("ti.catalog.msp430.peripherals.oa.IOA.OAN_0"), "OAP", om.find("ti.catalog.msp430.peripherals.oa.IOA.OAP_0"), "OAPM", om.find("ti.catalog.msp430.peripherals.oa.IOA.OAPM_0"), "OAADC0", om.find("ti.catalog.msp430.peripherals.oa.IOA.OAADC0_OFF"), "OAADC1", om.find("ti.catalog.msp430.peripherals.oa.IOA.OAADC1_OFF")), "wh");
        po.addFld("OA0CTL1", (Proto)om.findStrict("ti.catalog.msp430.peripherals.oa.OA_3.OAxCTL1_t", "ti.catalog.msp430.peripherals.oa"), Global.newObject("OAFBR", om.find("ti.catalog.msp430.peripherals.oa.IOA.OAFBR_0"), "OAFC", om.find("ti.catalog.msp430.peripherals.oa.IOA.OAFC_0"), "OANEXT", om.find("ti.catalog.msp430.peripherals.oa.IOA.OANEXT_OFF"), "OARRIP", om.find("ti.catalog.msp430.peripherals.oa.IOA.OARRIP_OFF")), "wh");
        po.addFld("OA1CTL0", (Proto)om.findStrict("ti.catalog.msp430.peripherals.oa.OA_3.OAxCTL0_t", "ti.catalog.msp430.peripherals.oa"), Global.newObject("OAN", om.find("ti.catalog.msp430.peripherals.oa.IOA.OAN_0"), "OAP", om.find("ti.catalog.msp430.peripherals.oa.IOA.OAP_0"), "OAPM", om.find("ti.catalog.msp430.peripherals.oa.IOA.OAPM_0"), "OAADC0", om.find("ti.catalog.msp430.peripherals.oa.IOA.OAADC0_OFF"), "OAADC1", om.find("ti.catalog.msp430.peripherals.oa.IOA.OAADC1_OFF")), "wh");
        ...
        po.addFld("OA2CTL1", (Proto)om.findStrict("ti.catalog.msp430.peripherals.oa.OA_3.OAxCTL1_t", "ti.catalog.msp430.peripherals.oa"), Global.newObject("OAFBR", om.find("ti.catalog.msp430.peripherals.oa.IOA.OAFBR_0"), "OAFC", om.find("ti.catalog.msp430.peripherals.oa.IOA.OAFC_0"), "OANEXT", om.find("ti.catalog.msp430.peripherals.oa.IOA.OANEXT_OFF"), "OARRIP", om.find("ti.catalog.msp430.peripherals.oa.IOA.OARRIP_OFF")), "wh");
        po.addFld("forceSetDefaultRegister", new Proto.Arr((Proto)om.findStrict("ti.catalog.msp430.peripherals.oa.OA_3.ForceSetDefaultRegister_t", "ti.catalog.msp430.peripherals.oa"), false), Global.newArray(new Object[]{Global.newObject("register", "OA0CTL0", "regForceSet", false), Global.newObject("register", "OA0CTL1", "regForceSet", false), Global.newObject("register", "OA1CTL0", "regForceSet", false), Global.newObject("register", "OA1CTL1", "regForceSet", false), Global.newObject("register", "OA2CTL0", "regForceSet", false), Global.newObject("register", "OA2CTL1", "regForceSet", false)}), "rh");
        po = (Proto.Obj)om.findStrict("ti.catalog.msp430.peripherals.oa.OA_3$$Object", "ti.catalog.msp430.peripherals.oa");
        po.init("ti.catalog.msp430.peripherals.oa.OA_3.Object", om.findStrict("ti.catalog.msp430.peripherals.oa.OA_3.Instance", "ti.catalog.msp430.peripherals.oa"));
                fxn = Global.get(cap, "getNumberOfOA");
                if (fxn != null) po.addFxn("getNumberOfOA", (Proto.Fxn)om.findStrict("ti.catalog.msp430.peripherals.oa.IOA$$getNumberOfOA", "ti.catalog.msp430.peripherals.oa"), fxn);
    }
    ...
    void OA_3$$SINGLETONS()
    {
        Proto.Obj po;
        Value.Obj vo;

        vo = (Value.Obj)om.findStrict("ti.catalog.msp430.peripherals.oa.OA_3", "ti.catalog.msp430.peripherals.oa");
        po = (Proto.Obj)om.findStrict("ti.catalog.msp430.peripherals.oa.OA_3.Module", "ti.catalog.msp430.peripherals.oa");
        vo.init2(po, "ti.catalog.msp430.peripherals.oa.OA_3", $$DEFAULT, false);
        vo.bind("Module", po);
        vo.bind("$category", "Module");
        vo.bind("$capsule", om.findStrict("ti.catalog.msp430.peripherals.oa.OA_3$$capsule", "ti.catalog.msp430.peripherals.oa"));
        vo.bind("Instance", om.findStrict("ti.catalog.msp430.peripherals.oa.OA_3.Instance", "ti.catalog.msp430.peripherals.oa"));
        vo.bind("Params", om.findStrict("ti.catalog.msp430.peripherals.oa.OA_3.Params", "ti.catalog.msp430.peripherals.oa"));
        vo.bind("PARAMS", ((Proto.Str)om.findStrict("ti.catalog.msp430.peripherals.oa.OA_3.Params", "ti.catalog.msp430.peripherals.oa")).newInstance());
        vo.bind("$package", om.findStrict("ti.catalog.msp430.peripherals.oa", "ti.catalog.msp430.peripherals.oa"));
        tdefs.clear();
        proxies.clear();
        mcfgs.clear();
        ...
        Proto.Str ps = (Proto.Str)vo.find("Module_State");
        if (ps != null) vo.bind("$object", ps.newInstance());
        vo.bind("$$meta_iobj", om.has("ti.catalog.msp430.peripherals.oa.OA_3$$instance$static$init", null) ? 1 : 0);
        vo.bind("$$fxntab", Global.newArray());
        vo.bind("$$logEvtCfgs", Global.newArray());
        vo.bind("$$errorDescCfgs", Global.newArray());
        vo.bind("$$assertDescCfgs", Global.newArray());
        Value.Map atmap = (Value.Map)vo.getv("$attr");
        atmap.seal("length");
        vo.bind("Object", om.findStrict("ti.catalog.msp430.peripherals.oa.OA_3.Object", "ti.catalog.msp430.peripherals.oa"));
        pkgV.bind("OA_3", vo);
        ((Value.Arr)pkgV.getv("$unitNames")).add("OA_3");
    }
    ...
    void $$INITIALIZATION()
    {
        ...
        Global.callFxn("module$meta$init", (Scriptable)om.findStrict("ti.catalog.msp430.peripherals.oa.OA_3", "ti.catalog.msp430.peripherals.oa"));
        ...
        ((Value.Obj)om.getv("ti.catalog.msp430.peripherals.oa.OA_3")).bless();
