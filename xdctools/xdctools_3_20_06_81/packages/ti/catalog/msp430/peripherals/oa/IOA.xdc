...
metaonly interface IOA inherits xdc.platform.IPeripheral {
    ...
    enum OAN_t {
      ...
      OAN_2 = (2*0x400u),     /*! OAxIA (see the device-specific data sheet for connected signal) */
      OAN_3 = 3*0x400u        /*! OAxIB (see the device-specific data sheet for connected signal) */
    };
    ...
    enum OAP_t {
      ...
      OAP_2 = (2*0x400u),     /*! OAxIA (see the device-specific data sheet for connected signal) */
      OAP_3 = 3*0x400u        /*! OAxIB (see the device-specific data sheet for connected signal) */
    };
     
    /*! Slew rate select */
    enum OAPM_t {
      OAPM_0 = (0*0x400u),     /*! OAx Power mode select: Off, output high Z */
      OAPM_1 = (1*0x400u),     /*! OAx Power mode select: Slow */
      OAPM_2 = (2*0x400u),     /*! OAx Power mode select: Medium */
      OAPM_3 = 3*0x400u        /*! OAx Power mode select: Fast */
    };
    ...
    enum OAFC_t {
      OAFC_0 = (0*0x100u),         /* OAx Function: Gen. Purpose */
      OAFC_1 = (1*0x100u),         /* OAx Function: Unity gain buffer*/
      OAFC_2 = (2*0x100u),         /* OAx Function: Reserved */
      OAFC_3 = (3*0x100u),         /* OAx Function: Comparator */
      OAFC_4 = (4*0x100u),         /* OAx Function: Non-inverting PGA */
      OAFC_5 = (5*0x100u),         /* OAx Function: Cascaded non-inverting PGA */
      OAFC_6 = (6*0x100u),         /* OAx Function: Inverting PGA */
      OAFC_7 = (7*0x100u)          /* OAx Function: Differential amplifier */
    };
