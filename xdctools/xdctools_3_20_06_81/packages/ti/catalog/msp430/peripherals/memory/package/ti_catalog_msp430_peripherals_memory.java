...
public class ti_catalog_msp430_peripherals_memory
{
    ...
    void IFlash$$CONSTS()
    {
        ...
        om.bind("ti.catalog.msp430.peripherals.memory.IFlash.FSSEL_3", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.catalog.msp430.peripherals.memory.IFlash.FSSEL_t", "ti.catalog.msp430.peripherals.memory"), "ti.catalog.msp430.peripherals.memory.IFlash.FSSEL_3", xdc.services.intern.xsr.Enum.intValue(0x00C0L)+0));
    ...
    void Flash_2xx$$TYPES()
    {
        ...
        po.init("ti.catalog.msp430.peripherals.memory.Flash_2xx.Module", om.findStrict("ti.catalog.msp430.peripherals.memory.IFlash.Module", "ti.catalog.msp430.peripherals.memory"));
                ...
                po.addFxn("addPeripheralsMap", (Proto.Fxn)om.findStrict("xdc.platform.IPeripheral$$addPeripheralsMap", "ti.catalog.msp430.peripherals.memory"), $$UNDEF);
                po.addFxn("getAll", (Proto.Fxn)om.findStrict("xdc.platform.IPeripheral$$getAll", "ti.catalog.msp430.peripherals.memory"), $$UNDEF);
                po.addFxn("getRegisters", (Proto.Fxn)om.findStrict("xdc.platform.IPeripheral$$getRegisters", "ti.catalog.msp430.peripherals.memory"), $$UNDEF);
        ...
        po.addFld("forceSetDefaultRegister", new Proto.Arr((Proto)om.findStrict("ti.catalog.msp430.peripherals.memory.Flash_2xx.ForceSetDefaultRegister_t", "ti.catalog.msp430.peripherals.memory"), false), Global.newArray(new Object[]{Global.newObject("register", "FCTL1", "regForceSet", false)}), "rh");
        ...
        po.init("ti.catalog.msp430.peripherals.memory.Flash_2xx.FCTL2_t", null);
                ...
                po.addFld("FN2", (Proto)om.findStrict("ti.catalog.msp430.peripherals.memory.Flash_2xx.FN3_t", "ti.catalog.msp430.peripherals.memory"), $$UNDEF, "w");
    ...
    void IFlash$$SINGLETONS()
    {
        ...
        vo.bind("FSSEL_3", om.findStrict("ti.catalog.msp430.peripherals.memory.IFlash.FSSEL_3", "ti.catalog.msp430.peripherals.memory"));
