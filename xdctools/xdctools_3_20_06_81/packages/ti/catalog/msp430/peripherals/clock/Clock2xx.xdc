 ...
 *  MSP430 Master Clock
 */
metaonly module Clock2xx inherits IClock {
    ...
    enum RSEL0_t {
        ...
        RSEL0 = 0x80        /*! Enable RSEL0 bit */
    };
    
    enum RSEL1_t {
        RSEL1_OFF = 0x00,   /*! Disable RSEL1 bit */
        RSEL1 = 0x80        /*! Enable RSEL1 bit */
    };
    
    enum RSEL2_t {
        RSEL2_OFF = 0x00,   /*! Disable RSEL2 bit */
        RSEL2 = 0x80        /*! Enable RSEL2 bit */
    };
    
    enum RSEL3_t {
        RSEL3_OFF = 0x00,   /*! Disable RSEL3 bit */
        RSEL3 = 0x80        /*! Enable RSEL3 bit */
    };
...
/*        SELM_1 = 0x40,       DCOCLK */
    ...
    enum DCOR_t {
        ...
        DCOR = 0x40         /*! DCO uses external resistor */
    };
    ...
    enum LFXT1S_t {
        LFXT1S_0 = 0x00,    /*! XTS = 0, 32768kHz Crystal ; XTS = 1, 0.4 - 1-MHz crystal or resonator */
        LFXT1S_1 = 0x10,    /*! XTS = 0, Reserved         ; XTS = 1, 1 - 3-MHz crystal or resonator */
        LFXT1S_2 = 0x20,    /*! XTS = 0, VLOCLK           ; XTS = 1, 3 - 16-MHz crystal or resonator */
        LFXT1S_3 = 0x30     /*! XTS = 0, Digital External ; XTS = 1, 0.4 - 16-MHz Digital External */
    };
    ...
    /*
     *  ======== PreCalibratedValues_t ========
     */
    enum PreCalibratedValues_t {
        PreCal_0,               /*! 1 MHz */
        PreCal_1,               /*! 8 MHz */
        PreCal_2,               /*! 12 MHz */
        PreCal_3,               /*! 16 MHz */
    ...
    create(IE1.Instance interruptEnableRegister1);
...
instance:
    ...
    config PreCalibratedValues_t preCalibratedValues = PreCal_0;
