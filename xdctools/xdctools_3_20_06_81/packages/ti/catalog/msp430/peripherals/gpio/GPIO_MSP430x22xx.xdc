...
/*!
 *  ======== GPIO for MSP430x22xx ========
 *  MSP430 General Purpose Input Output Ports
 */
metaonly module GPIO_MSP430x22xx inherits IGPIO {
    /*!
     *  ======== create ========
