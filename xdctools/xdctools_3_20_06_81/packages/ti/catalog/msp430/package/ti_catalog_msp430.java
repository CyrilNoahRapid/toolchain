...
public class ti_catalog_msp430
{
    ...
    void IMSP430F54xx$$TYPES()
    {
        ...
        po.addFld("TA0", (Proto)om.findStrict("ti.catalog.msp430.peripherals.timer.Timer_A5.Instance", "ti.catalog.msp430"), $$UNDEF, "wh");
        po.addFld("TA1", (Proto)om.findStrict("ti.catalog.msp430.peripherals.timer.Timer_A3.Instance", "ti.catalog.msp430"), $$UNDEF, "wh");
        po.addFld("TB0", (Proto)om.findStrict("ti.catalog.msp430.peripherals.timer.Timer_B7.Instance", "ti.catalog.msp430"), $$UNDEF, "wh");
    ...
    void IMSP430F55xx$$TYPES()
    {
        ...
        po.addFld("TA0", (Proto)om.findStrict("ti.catalog.msp430.peripherals.timer.Timer_A5.Instance", "ti.catalog.msp430"), $$UNDEF, "wh");
        po.addFld("TA1", (Proto)om.findStrict("ti.catalog.msp430.peripherals.timer.Timer_A3.Instance", "ti.catalog.msp430"), $$UNDEF, "wh");
        po.addFld("TA2", (Proto)om.findStrict("ti.catalog.msp430.peripherals.timer.Timer_A3.Instance", "ti.catalog.msp430"), $$UNDEF, "wh");
        po.addFld("TB0", (Proto)om.findStrict("ti.catalog.msp430.peripherals.timer.Timer_B7.Instance", "ti.catalog.msp430"), $$UNDEF, "wh");
        po.addFld("wdtPlus", (Proto)om.findStrict("ti.catalog.msp430.peripherals.watchdog.WDTPlus.Instance", "ti.catalog.msp430"), $$UNDEF, "wh");
        po.addFld("interruptController", (Proto)om.findStrict("ti.catalog.msp430.peripherals.interrupt.Interrupt_Controller.Instance", "ti.catalog.msp430"), $$UNDEF, "wh");
    ...
    void IMSP430x22xx$$TYPES()
    {
        ...
        po.addFld("clock", (Proto)om.findStrict("ti.catalog.msp430.peripherals.clock.Clock2xx.Instance", "ti.catalog.msp430"), $$UNDEF, "wh");
        ...
        po.addFld("gpio", (Proto)om.findStrict("ti.catalog.msp430.peripherals.gpio.GPIO_MSP430x22xx.Instance", "ti.catalog.msp430"), $$UNDEF, "wh");
    ...
    void $$SINGLETONS()
    {
        ...
        imports.add(Global.newArray("ti.catalog.msp430.peripherals.timer", Global.newArray()));
        imports.add(Global.newArray("ti.catalog.msp430.peripherals.adc", Global.newArray()));
        imports.add(Global.newArray("ti.catalog.msp430.peripherals.clock", Global.newArray()));
        imports.add(Global.newArray("ti.catalog.msp430.peripherals.communication", Global.newArray()));
        imports.add(Global.newArray("ti.catalog.msp430.peripherals.gpio", Global.newArray()));
        imports.add(Global.newArray("ti.catalog.msp430.peripherals.oa", Global.newArray()));
        imports.add(Global.newArray("ti.catalog.msp430.peripherals.special_function", Global.newArray()));
        imports.add(Global.newArray("ti.catalog.msp430.peripherals.watchdog", Global.newArray()));
        imports.add(Global.newArray("ti.catalog.msp430.peripherals.interrupt", Global.newArray()));
