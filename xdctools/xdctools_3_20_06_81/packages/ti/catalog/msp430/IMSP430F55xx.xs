...
function instance$meta$init()
{
    ...
    var TimerA3 = xdc.useModule("ti.catalog.msp430.peripherals.timer.Timer_A3");
    var TimerA5 = xdc.useModule("ti.catalog.msp430.peripherals.timer.Timer_A5");
    var TimerB7 = xdc.useModule("ti.catalog.msp430.peripherals.timer.Timer_B7");
    ...
    this.TA0 = TimerA5.create(
        clock, {name: "TA0", baseAddr: 0x340, intNum: 53}
    );
    this.TA1 = TimerA3.create(
        clock, {name: "TA1", baseAddr: 0x380, intNum: 49}
    );
    this.TA2 = TimerA3.create(
        clock, {name: "TA2", baseAddr: 0x400, intNum: 44}
    );
    this.TB0 = TimerB7.create(
        clock, {name: "TB0", baseAddr: 0x3C0, intNum: 59}
    );
    this.interruptController = IC.create(
        {name: "interruptController", baseAddr: 0xFF80, numInterrupts: 64});
    this.wdtPlus = WdtPlus.create(clock, ie1,
        {name: "wdtPlus", baseAddr: 0x15c});
}
