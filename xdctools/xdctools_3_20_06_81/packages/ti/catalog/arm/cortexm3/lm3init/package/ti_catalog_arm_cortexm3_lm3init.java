...
public class ti_catalog_arm_cortexm3_lm3init
{
    ...
    void Boot$$OBJECTS()
    {
        ...
        om.bind("ti.catalog.arm.cortexm3.lm3init.Boot.ModuleView", new Proto.Str(spo, true));
    ...
    void Boot$$TYPES()
    {
        ...
        po.init("ti.catalog.arm.cortexm3.lm3init.Boot.Module", $$Module);
        ...
        po.addFld("sysClockDiv", (Proto)om.findStrict("ti.catalog.arm.cortexm3.lm3init.Boot.SysDiv", "ti.catalog.arm.cortexm3.lm3init"), om.find("ti.catalog.arm.cortexm3.lm3init.Boot.SYSDIV_1"), "wh");
        po.addFld("pwmClockDiv", (Proto)om.findStrict("ti.catalog.arm.cortexm3.lm3init.Boot.PwmDiv", "ti.catalog.arm.cortexm3.lm3init"), om.find("ti.catalog.arm.cortexm3.lm3init.Boot.PWMDIV_1"), "wh");
        po.addFld("xtal", (Proto)om.findStrict("ti.catalog.arm.cortexm3.lm3init.Boot.XtalFreq", "ti.catalog.arm.cortexm3.lm3init"), om.find("ti.catalog.arm.cortexm3.lm3init.Boot.XTAL_1MHZ"), "wh");
        po.addFld("oscSrc", (Proto)om.findStrict("ti.catalog.arm.cortexm3.lm3init.Boot.OscSrc", "ti.catalog.arm.cortexm3.lm3init"), om.find("ti.catalog.arm.cortexm3.lm3init.Boot.OSCSRC_MAIN"), "wh");
        ...
        po.addFld("ldoOut", (Proto)om.findStrict("ti.catalog.arm.cortexm3.lm3init.Boot.LdoOut", "ti.catalog.arm.cortexm3.lm3init"), om.find("ti.catalog.arm.cortexm3.lm3init.Boot.LDOPCTL_2_50V"), "wh");
    ...
    void Boot$$SINGLETONS()
    {
        ...
        vo.bind("$$meta_iobj", om.has("ti.catalog.arm.cortexm3.lm3init.Boot$$instance$static$init", null) ? 1 : 0);
