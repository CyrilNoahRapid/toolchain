...
function module$use()
{
    ...
    Reset.fxns[Reset.fxns.length++] = '&ti_catalog_arm_cortexm3_lm3init_Boot_init';
...
/*
 *  @(#) ti.catalog.arm.cortexm3.lm3init; 1, 0, 0,53; 12-3-2010 11:43:10; /db/ztree/library/trees/platform/platform-l29x/src/
 */
