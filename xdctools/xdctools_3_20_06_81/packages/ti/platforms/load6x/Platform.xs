...
function getExecCmd(prog, packagePath)
{
    ...
    if (os == "Windows") {
        if (prog.build.target.isa == "64") {
            return (packagePath + "Windows/load6x.exe -q $(1) " + prog.name);
        }
    }
...
/*
 *  @(#) ti.platforms.load6x; 1, 0, 1, 1,53; 12-3-2010 12:53:39; /db/ztree/library/trees/platform/platform-l29x/src/
 */
