...
public class ti_platforms_simArctic
{
    ...
    void Platform$$TYPES()
    {
        ...
        po.addFld("T16", (Proto)om.findStrict("xdc.platform.IExeContext.Cpu", "ti.platforms.simArctic"), Global.newObject("id", "0", "clockRate", 200.0, "catalogName", "ti.catalog.t16", "deviceName", "T16v200", "revision", ""), "rh");
        ...
        po.init("ti.platforms.simArctic.Platform.Instance", om.findStrict("xdc.platform.IPlatform.Instance", "ti.platforms.simArctic"));
                po.addFld("$hostonly", $$T_Num, 1, "r");
        po.addFld("externalMemoryMap", new Proto.Map((Proto)om.findStrict("xdc.platform.IPlatform.Memory", "ti.platforms.simArctic")), Global.newArray(new Object[]{Global.newArray(new Object[]{"DDR", Global.newObject("name", "DDR", "base", 0x80000000L, "len", 0x80000000L)})}), "rh");
