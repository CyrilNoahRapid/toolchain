...
function getExecCmd(prog)
{
    ...
    if (os == "Windows" || os == "Linux") {
        ...
        command += "  -t " + timeout + " -s -r -n :TMS320C28XX " + verbose;
        command += " -b " + this.ftpath + "/targetdb/Sim_C28xx.xml";
...
/*
 *  @(#) ti.platforms.sim28xx; 1, 0, 1, 1,53; 12-3-2010 12:55:25; /db/ztree/library/trees/platform/platform-l29x/src/
 */
