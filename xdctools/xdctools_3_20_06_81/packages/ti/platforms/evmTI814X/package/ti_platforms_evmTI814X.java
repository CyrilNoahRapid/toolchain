...
public class ti_platforms_evmTI814X
{
    ...
    void Platform$$TYPES()
    {
        ...
        po.addFld("GEM", (Proto)om.findStrict("xdc.platform.IExeContext.Cpu", "ti.platforms.evmTI814X"), Global.newObject("id", "0", "clockRate", 800.0, "catalogName", "ti.catalog.c6000", "deviceName", "TMS320TI814X", "revision", ""), "rh");
        po.addFld("DSS", (Proto)om.findStrict("xdc.platform.IExeContext.Cpu", "ti.platforms.evmTI814X"), Global.newObject("id", "1", "clockRate", 250.0, "catalogName", "ti.catalog.arm.cortexm3", "deviceName", "TMS320TI814X", "revision", "1.0"), "rh");
        po.addFld("GPP", (Proto)om.findStrict("xdc.platform.IExeContext.Cpu", "ti.platforms.evmTI814X"), Global.newObject("id", "2", "clockRate", 1000.0, "catalogName", "ti.catalog.arm.cortexa8", "deviceName", "TMS320TI814X", "revision", "1.0"), "rh");
