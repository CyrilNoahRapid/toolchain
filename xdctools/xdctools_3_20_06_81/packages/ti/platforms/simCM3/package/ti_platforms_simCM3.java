...
public class ti_platforms_simCM3
{
    ...
    void Platform$$TYPES()
    {
        ...
        po.addFld("CPU", (Proto)om.findStrict("xdc.platform.IExeContext.Cpu", "ti.platforms.simCM3"), Global.newObject("id", "0", "clockRate", 200.0, "catalogName", "ti.catalog.arm", "deviceName", "CortexM3", "revision", "1.0"), "rh");
