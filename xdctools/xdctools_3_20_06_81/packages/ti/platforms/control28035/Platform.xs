...
function module$use()
{
    ...
    if (Program.sectMap[Boot.bootCodeSection] === undefined) {
        ...
        Program.sectMap[Boot.bootCodeSection].loadSegment = "LSARAM";
    }
}
...
/*
 *  @(#) ti.platforms.control28035; 1, 0, 0,62; 12-3-2010 12:37:13; /db/ztree/library/trees/platform/platform-l29x/src/
 */
