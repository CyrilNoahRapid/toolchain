...
function getExecCmd(prog)
{
    ...
    if (os == "Linux") {
        if (prog.build.target.$name.indexOf("ti.targets.arm.elf") == 0) {
...
/*
 *  @(#) ti.platforms.sim470xx; 1, 0, 1, 1,53; 12-3-2010 12:55:38; /db/ztree/library/trees/platform/platform-l29x/src/
 */
