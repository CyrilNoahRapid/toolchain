...
* Rev. 1.1,  Fixed swapped IRMS_2 definitions
*
********************************************************************/
...
SFR_16BIT(IRMS_HI);                           /* ESP430 Return Value 24 */
SFR_16BIT(IRMS_LO);                           /* ESP430 Return Value 25 */
...
#define RET24                  IRMS_HI        /* Current RMS value last second I1 High Word */
#define RET25                  IRMS_LO        /* Current RMS value last second I1 Low Word */
