...
#define __MSP430_HAS_EDI_LEVEL_1__                /* Definition to show that it has EDI LEVEL 1 */
...
************************************************************/
#define __MSP430_HAS_EDI__                    /* Definition to show that Module is available */

SFR_16BIT(SYSCSAP);                           /* Configuration Space Address Port Register  */
SFR_8BIT(SYSCSAP_L);                          /* Configuration Space Address Port Register  */
SFR_8BIT(SYSCSAP_H);                          /* Configuration Space Address Port Register  */
SFR_16BIT(SYSCSDP);                           /* Configuration Space Data Port Register  */
SFR_8BIT(SYSCSDP_L);                          /* Configuration Space Data Port Register  */
SFR_8BIT(SYSCSDP_H);                          /* Configuration Space Data Port Register  */

#define CSPEDIKEYID            (0x0040)       /* EDI KEYID register */
#define CSPEDISE0              (0x0042)       /* EDI segment enable 0 register */
#define CSPEDISE1              (0x0044)       /* EDI segment enable 1 register */
#define CSPEDICTL              (0x0048)       /* EDI control register */
#define CSPEDISTAT             (0x004A)       /* EDI status register */
#define CSPEDIELOL             (0x004C)       /* EDI error location register low */
#define CSPEDIELOH             (0x004E)       /* EDI error location register high */
#define CSPEDIVPD              (0x0050)       /* EDI VP accelerator data register */

#define CSPEDIKEY              (0x454B)       /* Key to open EDI */

/* CSPEDISE0 Control Bits */
#define FSE0                   (0x0001)       /* Enable EDI for Address Range */
#define FSE1                   (0x0002)       /* Enable EDI for Address Range */
#define FSE2                   (0x0004)       /* Enable EDI for Address Range */
#define FSE3                   (0x0008)       /* Enable EDI for Address Range */
#define FSE4                   (0x0010)       /* Enable EDI for Address Range */
#define FSE5                   (0x0020)       /* Enable EDI for Address Range */
#define FSE6                   (0x0040)       /* Enable EDI for Address Range */
#define FSE7                   (0x0080)       /* Enable EDI for Address Range */
#define FSE8                   (0x0100)       /* Enable EDI for Address Range */
#define FSE9                   (0x0200)       /* Enable EDI for Address Range */
#define FSE10                  (0x0400)       /* Enable EDI for Address Range */
#define FSE11                  (0x0800)       /* Enable EDI for Address Range */
#define FSE12                  (0x1000)       /* Enable EDI for Address Range */
#define FSE13                  (0x2000)       /* Enable EDI for Address Range */
#define FSE14                  (0x4000)       /* Enable EDI for Address Range */
#define FSE15                  (0x8000)       /* Enable EDI for Address Range */

/* CSPEDISE1 Control Bits */
#define BSLE0                  (0x0001)       /* Enable EDI for BSL Memory 0 */
#define BSLE1                  (0x0002)       /* Enable EDI for BSL Memory 1 */
#define BSLE2                  (0x0004)       /* Enable EDI for BSL Memory 2 */
#define BSLE3                  (0x0008)       /* Enable EDI for BSL Memory 3 */
#define ISE_A                  (0x0010)       /* Enable EDI for Info Memory 0 */
#define ISE_B                  (0x0020)       /* Enable EDI for Info Memory 1 */
#define ISE_C                  (0x0040)       /* Enable EDI for Info Memory 2 */
#define ISE_D                  (0x0080)       /* Enable EDI for Info Memory 3 */
#define CNFSE                  (0x1000)       /* Enable EDI for Configuration Memory */
#define CALSE                  (0x2000)       /* Enable EDI for Calibration Memory */
#define BCE0                   (0x4000)       /* Enable EDI for BC Memory 0 */
#define BCE1                   (0x8000)       /* Enable EDI for BC Memory 1 */

/* CSPEDICTL Control Bits */
#define VPEN                   (0x0002)       /* EDI Vertical-Parity enable */
#define PGWDIS                 (0x0004)       /* EDI Parity generator write disable */
#define APGDIS                 (0x0008)       /* EDI Automatic Parity generation disable */
#define PERRIE                 (0x0010)       /* EDI Parity Error Interrupt Enable */
#define WPL                    (0x0100)       /* EDI Write Parity for low word */
#define WPH                    (0x0200)       /* EDI Write Parity for high word */
#define WP                     (0x0400)       /* EDI Write Parity */
#define EDIEN                  (0x0800)       /* EDI Enable EDI */
#define PERRENRST              (0x1000)       /* EDI Enable generation of PUC on Parity error */

/* CSPEDISTAT Control Bits */
#define RPL                    (0x0001)       /* EDI H-Parity read info for low word, 32 bit mode */
#define RPH                    (0x0002)       /* EDI H-Parity read info for high word, 32 bit mode */
#define RP                     (0x0004)       /* EDI H-Parity read info for low word, 8/16 bit mode */
#define PMODE                  (0x0008)       /* EDI Parity read mode select */
#define PERRIFG                (0x0010)       /* EDI Parity Error Interrupt Flag */
#define XHIT                   (0x0020)       /* EDI Address Match of an Error Cache Entry */
#define PPOS0                  (0x0100)       /* EDI Processor Status bit 0 */
#define PPOS1                  (0x0200)       /* EDI Processor Status bit 1 */
#define PPOS2                  (0x0400)       /* EDI Processor Status bit 2 */
#define PPOS3                  (0x0800)       /* EDI Processor Status bit 3 */
#define PPOS4                  (0x1000)       /* EDI Processor Status bit 4 */
#define PPOS5                  (0x2000)       /* EDI Processor Status bit 5 */
#define PPOS6                  (0x4000)       /* EDI Processor Status bit 6 */

#define CSPXADRLW0             (0x0080)       /* Error cache #0 address low reg. */
#define CSPXADRHW0             (0x0082)       /* Error cache #0 address high reg. */
#define CSPXDATA0              (0x0084)       /* Error cache #0 data register  */
#define CSPXADRLW1             (0x0088)       /* Error cache #1 address low reg. */
#define CSPXADRHW1             (0x008A)       /* Error cache #1 address high reg. */
#define CSPXDATA1              (0x008C)       /* Error cache #1 data register  */
#define CSPXADRLW2             (0x0090)       /* Error cache #2 address low reg. */
#define CSPXADRHW2             (0x0092)       /* Error cache #2 address high reg. */
#define CSPXDATA2              (0x0094)       /* Error cache #2 data register  */
#define CSPXADRLW3             (0x0098)       /* Error cache #3 address low reg. */
#define CSPXADRHW3             (0x009A)       /* Error cache #3 address high reg. */
#define CSPXDATA3              (0x009C)       /* Error cache #3 data register */
#define CSPECSKEYID            (0x00FE)       /* Error cache status / KEY register */

#define XDEN                   (0x0001)       /* Exchange Data Enable register */

#define ECV                    (0x0800)       /* Error Cache Violation */

#define CSPECSKEY0             (0x0001)
#define CSPECSKEY1             (0x0002)
#define CSPECSKEY2             (0x0004)
#define CSPECSKEY3             (0x0008)
#define CSPECSKEY4             (0x0010)
#define CSPECSKEY5             (0x0020)
#define CSPECSKEY6             (0x0040)
#define CSPECSKEY7             (0x0080)
#define CSPECSKEY8             (0x0100)
#define CSPECSKEY9             (0x0200)
#define CSPECSKEY10            (0x0400)
#define CSPECSKEY11            (0x0800)
#define CSPECSKEY12            (0x1000)
#define CSPECSKEY13            (0x2000)
#define CSPECSKEY14            (0x4000)
#define CSPECSKEY15            (0x8000)
#define CSPECSKEY              (0x584B)       /* Key to open Error Cache */

#define CSPGKEYID              (0x0000)       /* Configuration Space Key / ID reg. */
#define CSPTDCR                (0x000E)       /* Test/Debug control register */

#define CSPGKEY                (0x474B)       /* Key to open EDI */

/* CSPTDCR Control Bits */
#define E0EN                   (0x0001)       /* EDI Enables E0 port func. */
#define E1EN                   (0x0002)       /* EDI Enables E1 port func. */
#define E0OSEL0                (0x0004)       /* EDI E0 source select bit 0 */
#define E0OSEL1                (0x0008)       /* EDI E0 source select bit 1 */
#define E1OSEL0                (0x0020)       /* EDI E1 source select bit 0 */
#define E1OSEL1                (0x0040)       /* EDI E1 source select bit 1 */
#define E0OUT                  (0x0100)       /* EDI E0 port output. */
#define E1OUT                  (0x0200)       /* EDI E1 port output. */
#define E0IN                   (0x0400)       /* EDI E0 port input. */
#define E1IN                   (0x0800)       /* EDI E1 port input. */
#define E0XBKEN                (0x1000)       /* EDI Enables to fire an XHIT from E0 port */
#define E1XBKEN                (0x2000)       /* EDI Enables to fire an XHIT from E1 port */
#define XHITEN                 (0x4000)       /* EDI XHIT Interrupt Enable */
#define XCLR                   (0x8000)       /* EDI clear the XHIT FF */

#define E0OSEL_0               (0x0000)       /* EDI E0 source select: 0 */
#define E0OSEL_1               (0x0004)       /* EDI E0 source select: 1 */
#define E0OSEL_2               (0x0008)       /* EDI E0 source select: 2 */
#define E0OSEL_3               (0x000C)       /* EDI E0 source select: 3 */
#define E1OSEL_0               (0x0000)       /* EDI E1 source select: 0 */
#define E1OSEL_1               (0x0020)       /* EDI E1 source select: 1 */
#define E1OSEL_2               (0x0040)       /* EDI E1 source select: 2 */
#define E1OSEL_3               (0x00C0)       /* EDI E1 source select: 3 */

/************************************************************
* EDI Operation Variables
************************************************************/

SFR_20BIT(EdiOnREL);                          /* EDI-SW recov. err. reentry ptr */
SFR_16BIT(EdiOnRELL);                         /* EDI-SW recov. err. reentry ptr */
SFR_20BIT(EdiOnNEL);                          /* EDI-SW non rec. err. reentry ptr */
SFR_16BIT(EdiOnNELL);                         /* EDI-SW non rec. err. reentry ptr */
SFR_20BIT(EdiErrCbP);                         /* EDI-SW err. call back ptr - used by EDI support software (Level 1) */
SFR_16BIT(EdiErrCbPL);                        /* EDI-SW err. call back ptr - used by EDI support software (Level 1) */
SFR_20BIT(EdiEList);                          /* EDI Error list position - used by EDI support software */
SFR_16BIT(EdiEListL);                         /* EDI Error list position - used by EDI support software */
SFR_20BIT(EdiRList);                          /* EDI Recovery list position - used by EDI support software */
SFR_16BIT(EdiRListL);                         /* EDI Recovery list position - used by EDI support software */
SFR_16BIT(EdiUNMIPtr);                        /* EDI user's UNMI poiner - used by EDI support software */
SFR_8BIT(EdiUNMIPtr_L);                       /* EDI user's UNMI poiner - used by EDI support software */
SFR_8BIT(EdiUNMIPtr_H);                       /* EDI user's UNMI poiner - used by EDI support software */
SFR_16BIT(EdiPgmPW);                          /* EDI programming key */
SFR_8BIT(EdiPgmPW_L);                         /* EDI programming key */
SFR_8BIT(EdiPgmPW_H);                         /* EDI programming key */
SFR_16BIT(EdiOpMode);                         /* EDI operation mode register - used by EDI support software */
SFR_8BIT(EdiOpMode_L);                        /* EDI operation mode register - used by EDI support software */
SFR_8BIT(EdiOpMode_H);                        /* EDI operation mode register - used by EDI support software */
SFR_16BIT(EdiPCOffset);                       /* EDI Recovery PC Offset - used by EDI support software */
SFR_8BIT(EdiPCOffset_L);                      /* EDI Recovery PC Offset - used by EDI support software */
SFR_8BIT(EdiPCOffset_H);                      /* EDI Recovery PC Offset - used by EDI support software */

//******************************************
//for Plug-Ins only
SFR_20BIT(EdiPaErPtr);                        /* EDI PatchError PlugIn pointer */
SFR_16BIT(EdiPaErPtrL);                       /* EDI PatchError PlugIn pointer */
SFR_20BIT(EdiMaElPtr);                        /* EDI MaintElist PlugIn pointer */
SFR_16BIT(EdiMaElPtrL);                       /* EDI MaintElist PlugIn pointer */
SFR_20BIT(EdiWrElPtr);                        /* EDI WriteElist PlugIn pointer */
SFR_16BIT(EdiWrElPtrL);                       /* EDI WriteElist PlugIn pointer */
SFR_20BIT(EdiLdElPtr);                        /* EDI LoadElist PlugIn pointer */
SFR_16BIT(EdiLdElPtrL);                       /* EDI LoadElist PlugIn pointer */
...
#define SYSBERRIV_EDIXHIT      (0x0004)       /* SYSBERRIV : EDI XHIT */
#define SYSBERRIV_EDIPE        (0x0006)       /* SYSBERRIV : EDI Parity Error */
...
#define SYSRSTIV_EDIPE         (0x0022)       /* SYSRSTIV : EDI Parity Error */
...
SFR_8BIT(TA2CTL_L);                           /* Timer2_A3 Control */
SFR_8BIT(TA2CTL_H);                           /* Timer2_A3 Control */
SFR_16BIT(TA2CCTL0);                          /* Timer2_A3 Capture/Compare Control 0 */
SFR_8BIT(TA2CCTL0_L);                         /* Timer2_A3 Capture/Compare Control 0 */
SFR_8BIT(TA2CCTL0_H);                         /* Timer2_A3 Capture/Compare Control 0 */
SFR_16BIT(TA2CCTL1);                          /* Timer2_A3 Capture/Compare Control 1 */
SFR_8BIT(TA2CCTL1_L);                         /* Timer2_A3 Capture/Compare Control 1 */
SFR_8BIT(TA2CCTL1_H);                         /* Timer2_A3 Capture/Compare Control 1 */
SFR_16BIT(TA2CCTL2);                          /* Timer2_A3 Capture/Compare Control 2 */
SFR_8BIT(TA2CCTL2_L);                         /* Timer2_A3 Capture/Compare Control 2 */
SFR_8BIT(TA2CCTL2_H);                         /* Timer2_A3 Capture/Compare Control 2 */
SFR_16BIT(TA2R);                              /* Timer2_A3 */
SFR_8BIT(TA2R_L);                             /* Timer2_A3 */
SFR_8BIT(TA2R_H);                             /* Timer2_A3 */
SFR_16BIT(TA2CCR0);                           /* Timer2_A3 Capture/Compare 0 */
SFR_8BIT(TA2CCR0_L);                          /* Timer2_A3 Capture/Compare 0 */
SFR_8BIT(TA2CCR0_H);                          /* Timer2_A3 Capture/Compare 0 */
SFR_16BIT(TA2CCR1);                           /* Timer2_A3 Capture/Compare 1 */
SFR_8BIT(TA2CCR1_L);                          /* Timer2_A3 Capture/Compare 1 */
SFR_8BIT(TA2CCR1_H);                          /* Timer2_A3 Capture/Compare 1 */
SFR_16BIT(TA2CCR2);                           /* Timer2_A3 Capture/Compare 2 */
SFR_8BIT(TA2CCR2_L);                          /* Timer2_A3 Capture/Compare 2 */
SFR_8BIT(TA2CCR2_H);                          /* Timer2_A3 Capture/Compare 2 */
SFR_16BIT(TA2IV);                             /* Timer2_A3 Interrupt Vector Word */
SFR_8BIT(TA2IV_L);                            /* Timer2_A3 Interrupt Vector Word */
SFR_8BIT(TA2IV_H);                            /* Timer2_A3 Interrupt Vector Word */
SFR_16BIT(TA2EX0);                            /* Timer2_A3 Expansion Register 0 */
SFR_8BIT(TA2EX0_L);                           /* Timer2_A3 Expansion Register 0 */
SFR_8BIT(TA2EX0_H);                           /* Timer2_A3 Expansion Register 0 */
